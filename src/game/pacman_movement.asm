...
bra_fallback_to_current_direction:
    LDA ram_direction_2
    STA ram_direction_1
; Branch alias into speed-profile selection entry point
bra_select_speed_profile_entry:
...
bra_fold_borrow_into_step_count:
    CLC
...
bra_apply_tunnel_wrap_and_turn:
    LDA ram_obj_pos_X_hi
    CMP #$18
...
bra_set_tunnel_palette:
; 00-17 and A9-FF
    LDA #$20
    ORA ram_spr_pal
; Store updated Pac-Man sprite palette
bra_store_pacman_palette:
    STA ram_spr_pal
    LDA ram_obj_pos_X_hi
    CMP #$0B
...
bra_continue_step_loop:
    JMP loc_step_remaining_pixels

; Map dpad bit order to direction enum
tbl_dpad_to_direction:
