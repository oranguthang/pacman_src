...
handler_script10_intermission_runtime:
...
sub_run_intermission_scene_dispatch:
...
tbl_intermission_scene_handlers:
...
handler_scene00_wait_pacman_midpoint:
    LDA #$01
...
handler_scene01_handle_rip_transform:
    LDA ram_spr_pos_X_hi
    CMP #$80
...
handler_scene01_blink_rip_tiles_then_finish:
...
handler_scene02_chase_return_opening:
    LDY ram_intermission_substate
...
handler_scene02_wait_return_midpoint:
    LDA #$01
    STA ram_sfx_intermission_flag_a
    STA ram_sfx_intermission_flag_b
    LDA ram_spr_pos_X_hi
...
bra_scene02_spawn_chaser_actor:
    INC ram_intermission_substate
    INC ram_intermission_substate
    LDA #$4C
    STA ram_actor_sprite_set + $01
