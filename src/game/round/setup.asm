...
bra_after_stage_increment_check:
...
bra_param_block_base_ready:
    TAY
    LDX #$00
; Copy level parameter block to runtime RAM 009F..00B4
bra_copy_level_param_block:
...
bra_adjust_release_targets_by_pellets:
    LDA zp_work1
    CLC
...
bra_load_release_targets_from_table:
    LDX zp_work0
    LDA off_active_stage_profiles,X
    ASL
...
bra_release_queue_tail_start:
    LDA #$00
; Clear remaining release queue/state pairs
bra_clear_release_queue_tail:
    CPX #$06
...
bra_select_hud_packet:
; Copy HUD PPU packet into RAM buffer
bra_copy_hud_ppu_packet:
...
bra_copy_anim_palette_defaults:
...
bra_normalize_power_pellet_tiles:
...
tbl_round_init_anim_and_sprite_attr_defaults:
; animation
    .byte $04  ; 00
    .byte $0C  ; 01
    .byte $0A  ; 02
