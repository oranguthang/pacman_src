...
bra_advance_ready_group_counter:
    DEC zp_work4
...
bra_check_two_player_ready_layout:
    LDA ram_game_mode
...
bra_round_ready_tick_entry:
; Round-ready timer tick and thresholds
loc_round_ready_tick:
    LDA ram_shared_state_0
    CMP #$C0
...
tbl_ready_text_sprite_positions:
; X, Y
    .byte $44, $88  ; 00
    .byte $44, $60  ; 02
    .byte $50, $70  ; 04
