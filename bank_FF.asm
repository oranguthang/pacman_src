...
; ---------------------------------------------------------------------------
; BANK_FF subsystem map (quick navigation for reverse-engineering / C port):
; C033..C1DE  Boot/NMI/input/title-frame dispatcher
; C1F5..C98A  Title + attract + chase demo pre-game flow
; C98A..D04D  Gameplay script core + round init + HUD setup
; D0EF..D2FA  Timers/release/fruit/collision scoring runtime
; D2FB..D4C1  Pac-Man movement and direction logic
; D4C2..E25B  Ghost state machine, targeting, movement, maze interaction
; E2FF..E74A  Playfield/HUD utility draws + intermission setup
; E74B..EB41  Intermission scene runtime + animation state machines
; EB42..F3FF  Stage parameter tables, maze/sound data, audio engine support
; ---------------------------------------------------------------------------
...
C - - - - - 0x000050 00:C040: 10 FB     BPL bra_C03D_wait_vblank_ready
...
C - - - - - 0x00005E 00:C04E: D0 F8     BNE bra_C048_clear_ram_0000_003D
; A = 00
...
C - - - - - 0x000067 00:C057: D0 FB     BNE bra_C054_clear_ram_0087_07FF
C - - - - - 0x000069 00:C059: E6 01     INC ram_0001
C - - - - - 0x00006B 00:C05B: E4 01     CPX ram_0001
C - - - - - 0x00006D 00:C05D: D0 F5     BNE bra_C054_clear_ram_0087_07FF
...
C - - - - - 0x000087 00:C077: B9 EB C0  LDA tbl_C0EB_warm_boot_signature,Y
C - - - - - 0x00008A 00:C07A: D9 52 00  CMP ram_reset_check,Y
C - - - - - 0x00008D 00:C07D: D0 07     BNE bra_C086_cold_boot_path
C - - - - - 0x00008F 00:C07F: C8        INY
C - - - - - 0x000090 00:C080: C0 0F     CPY #$0F
C - - - - - 0x000092 00:C082: D0 F3     BNE bra_C077_check_warm_boot_signature
C - - - - - 0x000094 00:C084: F0 1A     BEQ bra_C0A0_boot_finalize_common    ; jmp
...
C - - - - - 0x00009D 00:C08D: D0 FA     BNE bra_C089_clear_zero_page_0000_00FF
; set 0052-0060
...
C - - - - - 0x0000A1 00:C091: B9 EB C0  LDA tbl_C0EB_warm_boot_signature,Y
C - - - - - 0x0000A4 00:C094: 99 52 00  STA ram_reset_check,Y
C - - - - - 0x0000A7 00:C097: C8        INY
C - - - - - 0x0000A8 00:C098: C0 0F     CPY #$0F
C - - - - - 0x0000AA 00:C09A: D0 F5     BNE bra_C091_write_warm_boot_signature
...
C - - - - - 0x0000BC 00:C0AC: D0 19     BNE bra_C0C7_init_apu_and_continue
C - - - - - 0x0000BE 00:C0AE: C5 46     CMP ram_current_player
C - - - - - 0x0000C0 00:C0B0: D0 15     BNE bra_C0C7_init_apu_and_continue
...
- - - - - - 0x0000D5 00:C0C5: D0 EB     BNE bra_C0B2_swap_player_state_blocks
...
C - - - - - 0x0000E1 00:C0D1: 20 18 EE  JSR sub_EE18_init_sound_engine
C - - - - - 0x0000E4 00:C0D4: 20 40 EE  JSR sub_EE40_clear_sound_engine_state
...
C - - - - - 0x0000F8 00:C0E8: 4C 68 C1  JMP loc_C168_main_frame_bootstrap
...
C - - - - - 0x000123 00:C113: 20 1C E2  JSR sub_E21C_sample_tiles_at_obj_ppu_positions
...
C - - - - - 0x00015B 00:C14B: D0 EB     BNE bra_C138_shift_in_controller_bits
...
C - - - - - 0x000163 00:C153: F0 02     BEQ bra_C157_store_active_player_input
...
C - - - - - 0x00016D 00:C15D: D0 03     BNE bra_C162_pop_regs_and_rti
...
C - - - - - 0x00017E 00:C16E: D0 FC     BNE bra_C16C_wait_nmi_complete
...
C - - - - - 0x000194 00:C184: D0 FA     BNE bra_C180_clear_oam_ram_0700_07FF
C - - - - - 0x000196 00:C186: 85 46     STA ram_current_player
C - - - - - 0x000198 00:C188: 20 FF E2  JSR sub_E2FF_clear_bg_nametables_and_attrs
C - - - - - 0x00019B 00:C18B: 20 84 C2  JSR sub_C284_upload_title_attribute_table
C - - - - - 0x00019E 00:C18E: 20 1F C2  JSR sub_C21F_draw_title_logo_and_text
C - - - - - 0x0001A1 00:C191: 20 93 E3  JSR sub_E393_draw_score_hud_dual
...
C - - - - - 0x0001B3 00:C1A3: B9 95 C3  LDA tbl_C395_title_background_palette,Y
C - - - - - 0x0001B6 00:C1A6: 8D 07 20  STA $2007
C - - - - - 0x0001B9 00:C1A9: C8        INY
C - - - - - 0x0001BA 00:C1AA: C0 10     CPY #$10
C - - - - - 0x0001BC 00:C1AC: D0 F5     BNE bra_C1A3_upload_background_palette
...
C - - - - - 0x0001E1 00:C1D1: D0 04     BNE bra_C1D7_select_nametable_2000
; if con_script_00
C - - - - - 0x0001E3 00:C1D3: A9 8A     LDA #$8A    ; nmt 2800
C - - - - - 0x0001E5 00:C1D5: D0 02     BNE bra_C1D9_commit_ppuctrl_base    ; jmp
...
C - - - - - 0x0001F4 00:C1E4: D0 FC     BNE bra_C1E2_wait_nmi_complete
C - - - - - 0x0001F6 00:C1E6: A4 3F     LDY ram_script
C - - - - - 0x0001F8 00:C1E8: B9 F5 C1  LDA tbl_C1F5_script_handlers_title_flow,Y
C - - - - - 0x0001FB 00:C1EB: 85 10     STA ram_indirect_jmp
C - - - - - 0x0001FD 00:C1ED: B9 F6 C1  LDA tbl_C1F5_script_handlers_title_flow + $01,Y
...
- D 2 - - - 0x000205 00:C1F5: FB C1     .word ofs_000_C1FB_script00_title_scroll_in
- D 2 - - - 0x000207 00:C1F7: BD C3     .word ofs_000_C3BD_script02_title_menu_idle
- D 2 - - - 0x000209 00:C1F9: 58 C4     .word ofs_000_C458_script04_attract_intro
...
C - - - - - 0x00020F 00:C1FF: F0 07     BEQ bra_C208_continue_title_scroll
- - - - - - 0x000211 00:C201: A9 02     LDA #con_script_02
- - - - - - 0x000213 00:C203: 85 3F     STA ram_script
- - - - - - 0x000215 00:C205: 4C 68 C1  JMP loc_C168_main_frame_bootstrap
...
C - - - - - 0x00021E 00:C20E: D0 0C     BNE bra_C21C_dispatch_next_frame
...
C - - - - - 0x00022C 00:C21C: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x00024E 00:C23E: B9 9F C2  LDA tbl_C29F_title_logo_tiles,Y
C - - - - - 0x000251 00:C241: 8D 07 20  STA $2007
C - - - - - 0x000254 00:C244: C8        INY
C - - - - - 0x000255 00:C245: C6 03     DEC ram_0003
C - - - - - 0x000257 00:C247: D0 F5     BNE bra_C23E_stream_logo_row_tiles
...
C - - - - - 0x000268 00:C258: D0 D3     BNE bra_C22D_draw_next_logo_row
; draw text
...
C - - - - - 0x000273 00:C263: B9 29 C3  LDA tbl_C329_title_logo_text_packets,Y
C - - - - - 0x000276 00:C266: 8D 06 20  STA $2006
C - - - - - 0x000279 00:C269: C8        INY
C - - - - - 0x00027A 00:C26A: B9 29 C3  LDA tbl_C329_title_logo_text_packets,Y
...
C - - - - - 0x000281 00:C271: B9 29 C3  LDA tbl_C329_title_logo_text_packets,Y
C - - - - - 0x000284 00:C274: C9 FF     CMP #$FF
C - - - - - 0x000286 00:C276: F0 06     BEQ bra_C27E_advance_to_next_logo_text_packet
C - - - - - 0x000288 00:C278: 8D 07 20  STA $2007
C - - - - - 0x00028B 00:C27B: C8        INY
C - - - - - 0x00028C 00:C27C: D0 F3     BNE bra_C271_stream_logo_text_until_ff
...
C - - - - - 0x000291 00:C281: D0 DD     BNE bra_C260_draw_next_logo_text_packet
...
C - - - - - 0x0002A3 00:C293: B9 A5 C3  LDA tbl_C3A5_title_attribute_bytes,Y
C - - - - - 0x0002A6 00:C296: 8D 07 20  STA $2007
C - - - - - 0x0002A9 00:C299: C8        INY
C - - - - - 0x0002AA 00:C29A: C0 18     CPY #$18
C - - - - - 0x0002AC 00:C29C: D0 F5     BNE bra_C293_upload_next_attribute_byte
...
C - - - - - 0x0003D1 00:C3C1: D0 19     BNE bra_C3DC_title_idle_tick
...
C - - - - - 0x0003D5 00:C3C5: B9 4D C4  LDA tbl_C44D_ppu_cmd_player_count_prompt,Y
C - - - - - 0x0003D8 00:C3C8: 99 4B 02  STA ram_ppu_buffer_main,Y
C - - - - - 0x0003DB 00:C3CB: C8        INY
C - - - - - 0x0003DC 00:C3CC: C9 FF     CMP #$FF
C - - - - - 0x0003DE 00:C3CE: D0 F5     BNE bra_C3C5_copy_menu_prompt_to_ppu_buffer
...
C - - - - - 0x0003FB 00:C3EB: D0 0B     BNE bra_C3F8_handle_select_toggle
...
C - - - - - 0x000405 00:C3F5: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x00040E 00:C3FE: F0 2F     BEQ bra_C42F_check_start_edge
...
C - - - - - 0x00041C 00:C40C: F0 21     BEQ bra_C42F_check_start_edge
...
C - - - - - 0x000428 00:C418: F0 01     BEQ bra_C41B_select_player_glyph_index
C - - - - - 0x00042A 00:C41A: E8        INX
; Select glyph pair index for 1P/2P prompt
bra_C41B_select_player_glyph_index:		; was: bra_C41B
C - - - - - 0x00042B 00:C41B: BD 55 C4  LDA tbl_C455_player_count_glyph_pair,X
C - - - - - 0x00042E 00:C41E: 8D 4D 02  STA ram_ppu_buffer_main + $02
C - - - - - 0x000431 00:C421: BD 56 C4  LDA tbl_C455_player_count_glyph_pair + $01,X
...
C - - - - - 0x00043C 00:C42C: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x000445 00:C435: D0 03     BNE bra_C43A_latch_start_state
C - - - - - 0x000447 00:C437: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x00044E 00:C43E: D0 03     BNE bra_C443_start_game_from_title
C - - - - - 0x000450 00:C440: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x000457 00:C447: 20 40 EE  JSR sub_EE40_clear_sound_engine_state
C - - - - - 0x00045A 00:C44A: 4C 8A C9  JMP loc_C98A_enter_gameplay_session
...
C - - - - - 0x00046C 00:C45C: F0 07     BEQ bra_C465_run_attract_substate
C - - - - - 0x00046E 00:C45E: A9 02     LDA #con_script_02
C - - - - - 0x000470 00:C460: 85 3F     STA ram_script
C - - - - - 0x000472 00:C462: 4C 68 C1  JMP loc_C168_main_frame_bootstrap
; Execute current attract substate handler
bra_C465_run_attract_substate:		; was: bra_C465
C - - - - - 0x000475 00:C465: A4 87     LDY ram_0087
C - - - - - 0x000477 00:C467: B9 74 C4  LDA tbl_C474_attract_substate_handlers,Y
C - - - - - 0x00047A 00:C46A: 85 10     STA ram_indirect_jmp
C - - - - - 0x00047C 00:C46C: B9 75 C4  LDA tbl_C474_attract_substate_handlers + $01,Y
...
- D 2 - - - 0x000484 00:C474: 8C C4     .word ofs_001_C48C_attract_substate_init
- D 2 - - - 0x000486 00:C476: B9 C4     .word ofs_001_C4B9_attract_substate_wait_30f
- D 2 - - - 0x000488 00:C478: B9 C4     .word ofs_001_C4B9_attract_substate_wait_30f_alias_04
- D 2 - - - 0x00048A 00:C47A: B9 C4     .word ofs_001_C4B9_attract_substate_wait_30f_alias_06
- D 2 - - - 0x00048C 00:C47C: B9 C4     .word ofs_001_C4B9_attract_substate_wait_30f_alias_08
- D 2 - - - 0x00048E 00:C47E: B9 C4     .word ofs_001_C4B9_attract_substate_wait_30f_alias_0A
- D 2 - - - 0x000490 00:C480: B9 C4     .word ofs_001_C4B9_attract_substate_wait_30f_alias_0C
- D 2 - - - 0x000492 00:C482: B9 C4     .word ofs_001_C4B9_attract_substate_wait_30f_alias_0E
- D 2 - - - 0x000494 00:C484: B9 C4     .word ofs_001_C4B9_attract_substate_wait_30f_alias_10
- D 2 - - - 0x000496 00:C486: B9 C4     .word ofs_001_C4B9_attract_substate_wait_30f_alias_12
- D 2 - - - 0x000498 00:C488: CF C4     .word ofs_001_C4CF_attract_substate_wait_80f
- D 2 - - - 0x00049A 00:C48A: C8 C6     .word ofs_001_C6C8_attract_chase_scene
...
C - - - - - 0x0004A2 00:C492: D0 FC     BNE bra_C490_wait_nmi_complete
...
C - - - - - 0x0004B2 00:C4A2: 20 1E C5  JSR sub_C51E_draw_attract_playfield_frame
C - - - - - 0x0004B5 00:C4A5: 20 4E C5  JSR sub_C54E_setup_attract_palette_and_attrs
C - - - - - 0x0004B8 00:C4A8: 20 EC C4  JSR sub_C4EC_build_attract_ppu_packet
...
C - - - - - 0x0004C6 00:C4B6: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x0004CF 00:C4BF: D0 0B     BNE bra_C4CC_dispatch_next_frame
C - - - - - 0x0004D1 00:C4C1: A9 00     LDA #$00
C - - - - - 0x0004D3 00:C4C3: 85 88     STA ram_0088
C - - - - - 0x0004D5 00:C4C5: 20 EC C4  JSR sub_C4EC_build_attract_ppu_packet
...
C - - - - - 0x0004DC 00:C4CC: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x0004E5 00:C4D5: F0 03     BEQ bra_C4DA_advance_substate_after_wait
C - - - - - 0x0004E7 00:C4D7: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x0004F2 00:C4E2: 4C DE C1  JMP loc_C1DE_script_dispatch_loop


; bzk garbage
- - - - - - 0x0004F5 00:C4E5: A9 01     LDA #$01
- - - - - - 0x0004F7 00:C4E7: 85 47     STA ram_game_mode
- - - - - - 0x0004F9 00:C4E9: 4C 8A C9  JMP loc_C98A_enter_gameplay_session
...
C - - - - - 0x0004FE 00:C4EE: B9 D3 C5  LDA tbl_C5D3_attract_ppu_packet_ptrs,Y
C - - - - - 0x000501 00:C4F1: 85 00     STA ram_0000
C - - - - - 0x000503 00:C4F3: B9 D4 C5  LDA tbl_C5D3_attract_ppu_packet_ptrs + $01,Y
...
C - - - - - 0x000512 00:C502: D0 F6     BNE bra_C4FA_copy_ppu_packet_to_buffer
C - - - - - 0x000514 00:C504: B1 00     LDA (ram_0000),Y    ; data from 0x0005E3 (last byte)
C - - - - - 0x000516 00:C506: F0 01     BEQ bra_C509_copy_optional_sprite_strip
...
C - - - - - 0x000523 00:C513: B9 88 C6  LDA tbl_C688_attract_sprite_strip_data,Y
C - - - - - 0x000526 00:C516: 99 60 07  STA ram_oam + $60,Y
C - - - - - 0x000529 00:C519: C8        INY
C - - - - - 0x00052A 00:C51A: CA        DEX
C - - - - - 0x00052B 00:C51B: D0 F6     BNE bra_C513_copy_attract_sprite_strip
...
C - - - - - 0x00054F 00:C53F: D0 F9     BNE bra_C53A_fill_frame_inner_row
...
C - - - - - 0x00055B 00:C54B: 10 DF     BPL bra_C52C_draw_next_frame_row
...
C - - - - - 0x000570 00:C560: D0 FA     BNE bra_C55C_clear_attr_block_23C0
...
C - - - - - 0x000588 00:C578: D0 FA     BNE bra_C574_write_eight_attr_bytes
C - - - - - 0x00058A 00:C57A: 18        CLC
C - - - - - 0x00058B 00:C57B: 69 55     ADC #$55
C - - - - - 0x00058D 00:C57D: C6 00     DEC ram_0000
C - - - - - 0x00058F 00:C57F: D0 F1     BNE bra_C572_fill_checker_attr_rows
...
C - - - - - 0x00059D 00:C58D: B9 B3 C5  LDA tbl_C5B3_attract_bg_spr_palette,Y
C - - - - - 0x0005A0 00:C590: 8D 07 20  STA $2007
C - - - - - 0x0005A3 00:C593: C8        INY
C - - - - - 0x0005A4 00:C594: C0 20     CPY #$20
C - - - - - 0x0005A6 00:C596: D0 F5     BNE bra_C58D_upload_attract_palette32
...
- D 2 - - - 0x0005E3 00:C5D3: E7 C5     .word off_C5E7_attract_text_header_character_nickname
- D 2 - - - 0x0005E5 00:C5D5: FF C5     .word off_C5FF_attract_text_alias_oikake
- D 2 - - - 0x0005E7 00:C5D7: 0E C6     .word off_C60E_attract_text_name_akabei
- D 2 - - - 0x0005E9 00:C5D9: 19 C6     .word off_C619_attract_text_alias_machibuse
- D 2 - - - 0x0005EB 00:C5DB: 28 C6     .word off_C628_attract_text_name_pinky
- D 2 - - - 0x0005ED 00:C5DD: 32 C6     .word off_C632_attract_text_alias_tiles_0A
- D 2 - - - 0x0005EF 00:C5DF: 41 C6     .word off_C641_attract_text_name_tiles_0C
- D 2 - - - 0x0005F1 00:C5E1: 4C C6     .word off_C64C_attract_text_alias_otoboke
- D 2 - - - 0x0005F3 00:C5E3: 5B C6     .word off_C65B_attract_text_name_guzuta
- D 2 - - - 0x0005F5 00:C5E5: 66 C6     .word off_C666_attract_text_points_table
...
- D 2 - I - 0x0005F9 00:C5E9: 43        .byte                               $43, $48, $52, $41, $43, $54, $45, $52, $20, $20   ; 
...
C - - - - - 0x0006DA 00:C6CA: B9 D7 C6  LDA tbl_C6D7_attract_chase_substates,Y
C - - - - - 0x0006DD 00:C6CD: 85 10     STA ram_indirect_jmp
C - - - - - 0x0006DF 00:C6CF: B9 D8 C6  LDA tbl_C6D7_attract_chase_substates + $01,Y
...
- D 2 - - - 0x0006E7 00:C6D7: DD C6     .word ofs_002_C6DD_chase_setup_intro_text
- D 2 - - - 0x0006E9 00:C6D9: 28 C7     .word ofs_002_C728_chase_run_from_ghosts
- D 2 - - - 0x0006EB 00:C6DB: 8D C7     .word ofs_002_C78D_chase_run_toward_ghosts
...
C - - - - - 0x0006EF 00:C6DF: B9 0E C9  LDA tbl_C90E_ppu_cmd_clear_points_text,Y
C - - - - - 0x0006F2 00:C6E2: 99 4B 02  STA ram_ppu_buffer_main,Y
C - - - - - 0x0006F5 00:C6E5: C8        INY
C - - - - - 0x0006F6 00:C6E6: C9 FF     CMP #$FF
C - - - - - 0x0006F8 00:C6E8: D0 F5     BNE bra_C6DF_copy_ppu_packet
...
C - - - - - 0x000723 00:C713: D0 F8     BNE bra_C70D_clear_runner_obj_slots
...
C - - - - - 0x00072C 00:C71C: D0 F8     BNE bra_C716_clear_runner_sprite_slots
C - - - - - 0x00072E 00:C71E: 20 5C DA  JSR sub_DA5C_build_oam_from_sprite_buffers
C - - - - - 0x000731 00:C721: E6 88     INC ram_0088
C - - - - - 0x000733 00:C723: E6 88     INC ram_0088
C - - - - - 0x000735 00:C725: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - J - - 0x000738 00:C728: 20 12 C8  JSR sub_C812_update_chase_scene_frame
C - - - - - 0x00073B 00:C72B: 20 EE C8  JSR sub_C8EE_blink_chase_marker
C - - - - - 0x00073E 00:C72E: AD 74 02  LDA ram_spr_pos_X_hi
C - - - - - 0x000741 00:C731: C9 E0     CMP #$E0
C - - - - - 0x000743 00:C733: F0 0C     BEQ bra_C741_spawn_next_ghost_if_checkpoint
C - - - - - 0x000745 00:C735: C9 D1     CMP #$D1
C - - - - - 0x000747 00:C737: F0 08     BEQ bra_C741_spawn_next_ghost_if_checkpoint
C - - - - - 0x000749 00:C739: C9 C2     CMP #$C2
C - - - - - 0x00074B 00:C73B: F0 04     BEQ bra_C741_spawn_next_ghost_if_checkpoint
C - - - - - 0x00074D 00:C73D: C9 B3     CMP #$B3
C - - - - - 0x00074F 00:C73F: D0 03     BNE bra_C744_check_phase_a_finish
; At checkpoint X, spawn next ghost runner
bra_C741_spawn_next_ghost_if_checkpoint:		; was: bra_C741
C - - - - - 0x000751 00:C741: 20 DE C7  JSR sub_C7DE_spawn_ghost_runner
...
C - - - - - 0x000759 00:C749: F0 03     BEQ bra_C74E_phase_a_to_b_reset
C - - - - - 0x00075B 00:C74B: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x000770 00:C760: D0 EE     BNE bra_C750_reset_phase_b_obj_slots
...
C - - - - - 0x00079A 00:C78A: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x00079F 00:C78F: F0 47     BEQ bra_C7D8_update_phase_b_scene
C - - - - - 0x0007A1 00:C791: 20 64 C8  JSR sub_C864_rotate_runner_slots
C - - - - - 0x0007A4 00:C794: C6 8A     DEC ram_008A
C - - - - - 0x0007A6 00:C796: F0 03     BEQ bra_C79B_resolve_eaten_ghost
C - - - - - 0x0007A8 00:C798: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x0007B2 00:C7A2: D0 03     BNE bra_C7A7_clear_eaten_slot_state
C - - - - - 0x0007B4 00:C7A4: C8        INY
C - - - - - 0x0007B5 00:C7A5: D0 F6     BNE bra_C79D_find_active_eaten_marker_slot    ; Y steps 0,4,8,0C so branch always until slot found
...
C - - - - - 0x0007DC 00:C7CC: F0 03     BEQ bra_C7D1_enter_gameplay_after_chase
C - - - - - 0x0007DE 00:C7CE: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x0007E5 00:C7D5: 4C 8A C9  JMP loc_C98A_enter_gameplay_session
; Phase B path when no eat event is active
bra_C7D8_update_phase_b_scene:		; was: bra_C7D8
C - - - - - 0x0007E8 00:C7D8: 20 12 C8  JSR sub_C812_update_chase_scene_frame
C - - - - - 0x0007EB 00:C7DB: 4C DE C1  JMP loc_C1DE_script_dispatch_loop
...
C - - - - - 0x0007F5 00:C7E5: F0 08     BEQ bra_C7EF_init_spawned_runner_slot
...
- - - - - - 0x0007FD 00:C7ED: D0 F3     BNE bra_C7E2_find_free_runner_slot
...
C - - - - - 0x000822 00:C812: 20 A5 E9  JSR sub_E9A5_update_intermission_actor_positions
C - - - - - 0x000825 00:C815: 20 64 C8  JSR sub_C864_rotate_runner_slots
C - - - - - 0x000828 00:C818: 20 30 C9  JSR sub_C930_update_chase_anim_tiles
C - - - - - 0x00082B 00:C81B: 20 21 C8  JSR sub_C821_handle_chase_contact
C - - - - - 0x00082E 00:C81E: 4C 5C DA  JMP loc_DA5C_build_oam_from_sprite_buffers
...
C - - - - - 0x000833 00:C823: 10 01     BPL bra_C826_scan_runners_for_contact
...
C - - - - - 0x000845 00:C835: F0 04     BEQ bra_C83B_advance_runner_scan
C - - - - - 0x000847 00:C837: C5 00     CMP ram_0000
C - - - - - 0x000849 00:C839: 90 0B     BCC bra_C846_mark_runner_eaten
...
C - - - - - 0x000853 00:C843: D0 ED     BNE bra_C832_find_first_runner_ahead_of_pacman
...
C - - - - - 0x00085E 00:C84E: B9 24 C9  LDA tbl_C924_ghost_score_tiles,Y
...
C - - - - - 0x000890 00:C880: D0 EC     BNE bra_C86E_rotate_object_positions_left
...
C - - - - - 0x0008B9 00:C8A9: D0 F5     BNE bra_C8A0_rotate_sprite_bytes_left
...
C - - - - - 0x0008DF 00:C8CF: D0 F5     BNE bra_C8C6_rotate_runner_tile_ids_left
...
C - - - - - 0x0008F6 00:C8E6: D0 F5     BNE bra_C8DD_rotate_runner_palette_flags_left
...
C - - - - - 0x000902 00:C8F2: F0 01     BEQ bra_C8F5_blink_tick
...
C - - - - - 0x00090D 00:C8FD: F0 02     BEQ bra_C901_select_marker_variant
...
C - - - - - 0x000911 00:C901: B9 28 C9  LDA tbl_C928_ppu_cmd_chase_marker,Y
...
C - - - - - 0x00091B 00:C90B: D0 F4     BNE bra_C901_copy_marker_packet
...
C - - - - - 0x000944 00:C934: 30 02     BMI bra_C938_store_anim_bank_offset
...
C - - - - - 0x000954 00:C944: B9 76 C9  LDA tbl_C976_chase_anim_lut,Y
C - - - - - 0x000957 00:C947: 8D 8C 02  STA ram_028C
C - - - - - 0x00095A 00:C94A: A5 4B     LDA ram_frame_cnt
C - - - - - 0x00095C 00:C94C: 29 07     AND #$07
C - - - - - 0x00095E 00:C94E: F0 01     BEQ bra_C951_update_ghost_tiles_every_8f
...
C - - - - - 0x000965 00:C955: F0 02     BEQ bra_C959_select_chomp_toggle
...
C - - - - - 0x00096F 00:C95F: B9 76 C9  LDA tbl_C976_chase_anim_lut,Y
...
C - - - - - 0x000979 00:C969: F0 05     BEQ bra_C970_next_runner_tile_slot
...
C - - - - - 0x000983 00:C973: D0 F1     BNE bra_C966_apply_ghost_tile_to_active_slots
...
C - - - - - 0x0009A4 00:C994: 10 FB     BPL bra_C991_wait_vblank_set
...
C - - - - - 0x0009B3 00:C9A3: 20 FF E2  JSR sub_E2FF_clear_bg_nametables_and_attrs
C - - - - - 0x0009B6 00:C9A6: 20 7C E4  JSR sub_E47C_upload_hud_text_blocks
C - - - - - 0x0009B9 00:C9A9: 20 79 E3  JSR sub_E379_draw_score_hud_live
C - - - - - 0x0009BC 00:C9AC: A5 48     LDA ram_flag_demo
C - - - - - 0x0009BE 00:C9AE: F0 06     BEQ bra_C9B6_init_non_demo_player_state
C - - - - - 0x0009C0 00:C9B0: A9 01     LDA #$01
C - - - - - 0x0009C2 00:C9B2: 85 67     STA ram_lives_p1
C - - - - - 0x0009C4 00:C9B4: D0 17     BNE bra_C9CD_reset_stage_counters    ; jmp
...
C - - - - - 0x0009CF 00:C9BF: D0 F8     BNE bra_C9B9_clear_player_runtime_block
...
C - - - - - 0x0009F3 00:C9E3: D0 FC     BNE bra_C9E1_wait_nmi_complete
C - - - - - 0x0009F5 00:C9E5: A5 48     LDA ram_flag_demo
C - - - - - 0x0009F7 00:C9E7: F0 0D     BEQ bra_C9F6_handle_script_delay
C - - - - - 0x0009F9 00:C9E9: A5 4D     LDA ram_btn_1p
C - - - - - 0x0009FB 00:C9EB: 29 0C     AND #con_btns_SS
C - - - - - 0x0009FD 00:C9ED: F0 07     BEQ bra_C9F6_handle_script_delay
- - - - - - 0x0009FF 00:C9EF: A9 02     LDA #con_script_02
- - - - - - 0x000A01 00:C9F1: 85 3F     STA ram_script
- - - - - - 0x000A03 00:C9F3: 4C 68 C1  JMP loc_C168_main_frame_bootstrap
...
C - - - - - 0x000A08 00:C9F8: F0 04     BEQ bra_C9FE_dispatch_current_script
C - - - - - 0x000A0A 00:C9FA: C6 4C     DEC ram_004C
C - - - - - 0x000A0C 00:C9FC: D0 DF     BNE bra_C9DD_loop_gameplay_tick
...
C - - - - - 0x000A10 00:CA00: B9 0D CA  LDA tbl_CA0D_gameplay_script_handlers,Y
C - - - - - 0x000A13 00:CA03: 85 10     STA ram_indirect_jmp
C - - - - - 0x000A15 00:CA05: B9 0E CA  LDA tbl_CA0D_gameplay_script_handlers + $01,Y
...
- D 2 - - - 0x000A1D 00:CA0D: 35 CE     .word ofs_003_CE35_script00_round_init
- D 2 - - - 0x000A1F 00:CA0F: 9D CA     .word ofs_003_CA9D_script02_round_ready
- D 2 - - - 0x000A21 00:CA11: 1F CA     .word ofs_003_CA1F_script04_pause_handler
- D 2 - - - 0x000A23 00:CA13: 0F CC     .word ofs_003_CC0F_script06_post_eat_pause
- D 2 - - - 0x000A25 00:CA15: 3C CC     .word ofs_003_CC3C_script08_death_sequence
- D 2 - - - 0x000A27 00:CA17: 61 CD     .word ofs_003_CD61_script0A_game_over
- D 2 - - - 0x000A29 00:CA19: E6 CC     .word ofs_003_CCE6_script0C_stage_clear
- D 2 - - - 0x000A2B 00:CA1B: 55 E6     .word ofs_003_E655_script0E_intermission_setup
- D 2 - - - 0x000A2D 00:CA1D: 4B E7     .word ofs_003_E74B_script10_intermission_runtime
...
C - - - - - 0x000A32 00:CA22: F0 03     BEQ bra_CA27_check_start_edge
C - - - - - 0x000A34 00:CA24: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000A3D 00:CA2D: F0 38     BEQ bra_CA67_run_frame_when_no_new_start
C - - - - - 0x000A3F 00:CA2F: 85 49     STA ram_0049
C - - - - - 0x000A41 00:CA31: A5 49     LDA ram_0049
C - - - - - 0x000A43 00:CA33: F0 32     BEQ bra_CA67_run_frame_when_no_new_start
...
C - - - - - 0x000A4D 00:CA3D: F0 02     BEQ bra_CA41_store_pause_ppu_addr
...
C - - - - - 0x000A61 00:CA51: F0 05     BEQ bra_CA58_select_pause_text_variant
...
C - - - - - 0x000A68 00:CA58: BD 91 CA  LDA tbl_CA91_pause_text_tiles,X
...
C - - - - - 0x000A72 00:CA62: D0 F4     BNE bra_CA58_copy_pause_tiles
C - - - - - 0x000A74 00:CA64: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000A7B 00:CA6B: F0 03     BEQ bra_CA70_run_unpaused_gameplay_step
C - - - - - 0x000A7D 00:CA6D: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
; Run gameplay update chain when not paused
bra_CA70_run_unpaused_gameplay_step:		; was: bra_CA70
C - - - - - 0x000A80 00:CA70: 20 EF D0  JSR sub_D0EF_update_round_timers_and_frightened
C - - - - - 0x000A83 00:CA73: 20 DF DE  JSR sub_DEDF_check_for_eating_pellets
C - - - - - 0x000A86 00:CA76: 20 FB D2  JSR sub_D2FB_update_pacman_movement
C - - - - - 0x000A89 00:CA79: 20 F9 D8  JSR sub_D8F9_update_pacman_anim_frame
C - - - - - 0x000A8C 00:CA7C: 20 C2 D4  JSR sub_D4C2_update_ghost_slots
C - - - - - 0x000A8F 00:CA7F: 20 37 D9  JSR sub_D937_update_ghost_anim_frames
C - - - - - 0x000A92 00:CA82: 20 C9 D8  JSR sub_D8C9_update_ghost_house_counters
C - - - - - 0x000A95 00:CA85: 20 C9 DD  JSR sub_DDC9_blink_power_pellet_tiles
C - - - - - 0x000A98 00:CA88: 20 0F D2  JSR sub_D20F_check_actor_collisions
C - - - - - 0x000A9B 00:CA8B: 20 AB D9  JSR sub_D9AB_prepare_sprite_positions
C - - - - - 0x000A9E 00:CA8E: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000AAF 00:CA9F: F0 03     BEQ bra_CAA4_build_ready_sprites
C - - - - - 0x000AB1 00:CAA1: 4C 1A CB  JMP loc_CB1A_round_ready_tick
...
C - - - - - 0x000ABE 00:CAAE: D0 6A     BNE bra_CB1A_round_ready_tick_entry
...
C - - - - - 0x000ACE 00:CABE: BD F6 CB  LDA tbl_CBF6_ready_text_sprite_positions,X
C - - - - - 0x000AD1 00:CAC1: 85 02     STA ram_0002    ; spr_X
C - - - - - 0x000AD3 00:CAC3: BD F7 CB  LDA tbl_CBF6_ready_text_sprite_positions + $01,X
C - - - - - 0x000AD6 00:CAC6: 85 03     STA ram_0003    ; spr_Y
C - - - - - 0x000AD8 00:CAC8: A6 07     LDX ram_0007
C - - - - - 0x000ADA 00:CACA: BD FC CB  LDA tbl_CBFC_ready_text_group_sizes,X
...
C - - - - - 0x000AE5 00:CAD5: BD D2 CB  LDA tbl_CBD2_ready_text_sprite_tiles,X
C - - - - - 0x000AE8 00:CAD8: C8        INY
C - - - - - 0x000AE9 00:CAD9: 91 00     STA (ram_0000),Y    ; 0761-0799 (spr_T)
C - - - - - 0x000AEB 00:CADB: BD E4 CB  LDA tbl_CBE4_ready_text_sprite_attrs,X
...
C - - - - - 0x000B02 00:CAF2: D0 DB     BNE bra_CACF_emit_ready_group_sprites
...
C - - - - - 0x000B0C 00:CAFC: D0 04     BNE bra_CB02_advance_ready_group_counter
C - - - - - 0x000B0E 00:CAFE: A5 68     LDA ram_stage_p1
C - - - - - 0x000B10 00:CB00: D0 18     BNE bra_CB1A_round_ready_tick_entry
...
C - - - - - 0x000B14 00:CB04: F0 04     BEQ bra_CB0A_check_two_player_ready_layout
C - - - - - 0x000B16 00:CB06: 10 B4     BPL bra_CABC_build_next_ready_group
C - - - - - 0x000B18 00:CB08: 30 10     BMI bra_CB1A_round_ready_tick_entry    ; jmp
...
C - - - - - 0x000B1C 00:CB0C: F0 0C     BEQ bra_CB1A_round_ready_tick_entry
C - - - - - 0x000B1E 00:CB0E: A5 46     LDA ram_current_player
C - - - - - 0x000B20 00:CB10: F0 AA     BEQ bra_CABC_build_next_ready_group
C - - - - - 0x000B22 00:CB12: E6 05     INC ram_0005
C - - - - - 0x000B24 00:CB14: E6 05     INC ram_0005
C - - - - - 0x000B26 00:CB16: E6 05     INC ram_0005
C - - - - - 0x000B28 00:CB18: D0 A2     BNE bra_CABC_build_next_ready_group   ; jmp
...
C - - - - - 0x000B2E 00:CB1E: D0 03     BNE bra_CB23_inc_ready_timer
; C0
C - - - - - 0x000B30 00:CB20: 4C B2 CB  JMP loc_CBB2_wait_ready_sfx_done
...
C - - - - - 0x000B39 00:CB29: F0 03     BEQ bra_CB2E_ready_timer_reached_78
C - - - - - 0x000B3B 00:CB2B: 4C CF CB  JMP loc_CBCF_return_gameplay_dispatch
...
C - - - - - 0x000B65 00:CB55: D0 F8     BNE bra_CB4F_clear_ready_oam_window
C - - - - - 0x000B67 00:CB57: A5 47     LDA ram_game_mode
C - - - - - 0x000B69 00:CB59: 25 46     AND ram_current_player
C - - - - - 0x000B6B 00:CB5B: F0 02     BEQ bra_CB5F_store_life_icon_offset
...
C - - - - - 0x000B78 00:CB68: B9 07 CC  LDA tbl_CC07_life_icons_ppu_addresses,Y
C - - - - - 0x000B7B 00:CB6B: 18        CLC
C - - - - - 0x000B7C 00:CB6C: 65 00     ADC ram_0000
C - - - - - 0x000B7E 00:CB6E: 85 00     STA ram_0000
C - - - - - 0x000B80 00:CB70: B9 08 CC  LDA tbl_CC07_life_icons_ppu_addresses + $01,Y
...
C - - - - - 0x000BB6 00:CBA6: 20 F9 D8  JSR sub_D8F9_update_pacman_anim_frame
C - - - - - 0x000BB9 00:CBA9: 20 37 D9  JSR sub_D937_update_ghost_anim_frames
C - - - - - 0x000BBC 00:CBAC: 20 AB D9  JSR sub_D9AB_prepare_sprite_positions
C - - - - - 0x000BBF 00:CBAF: 4C CF CB  JMP loc_CBCF_return_gameplay_dispatch
...
C - - - - - 0x000BC8 00:CBB8: D0 15     BNE bra_CBCF_return_dispatch
C - - - - - 0x000BCA 00:CBBA: A5 48     LDA ram_flag_demo
C - - - - - 0x000BCC 00:CBBC: D0 0D     BNE bra_CBCB_switch_to_pause_script
...
C - - - - - 0x000BD9 00:CBC9: D0 F8     BNE bra_CBC3_clear_ready_oam_tail
...
C D 2 - - - 0x000BDF 00:CBCF: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000C25 00:CC15: D0 16     BNE bra_CC2D_run_post_eat_updates
...
C - - - - - 0x000C37 00:CC27: D0 FA     BNE bra_CC23_find_matching_ghost_state_slot
...
C - - - - - 0x000C3D 00:CC2D: 20 C9 DD  JSR sub_DDC9_blink_power_pellet_tiles
C - - - - - 0x000C40 00:CC30: 20 7F D8  JSR sub_D87F_update_ghost_slots_state06_only
C - - - - - 0x000C43 00:CC33: 20 37 D9  JSR sub_D937_update_ghost_anim_frames
C - - - - - 0x000C46 00:CC36: 20 AB D9  JSR sub_D9AB_prepare_sprite_positions
C - - - - - 0x000C49 00:CC39: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000C4E 00:CC3E: D0 23     BNE bra_CC63_run_death_anim_phase
C - - - - - 0x000C50 00:CC40: C6 DB     DEC ram_00DB
C - - - - - 0x000C52 00:CC42: D0 13     BNE bra_CC57_run_pre_death_frame_updates
...
C - - - - - 0x000C65 00:CC55: D0 F9     BNE bra_CC50_clear_actor_slots_for_death
; Death sequence pre-animation update frame
bra_CC57_run_pre_death_frame_updates:		; was: bra_CC57
C - - - - - 0x000C67 00:CC57: 20 C9 DD  JSR sub_DDC9_blink_power_pellet_tiles
C - - - - - 0x000C6A 00:CC5A: 20 37 D9  JSR sub_D937_update_ghost_anim_frames
C - - - - - 0x000C6D 00:CC5D: 20 AB D9  JSR sub_D9AB_prepare_sprite_positions
C - - - - - 0x000C70 00:CC60: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000C75 00:CC65: 10 0F     BPL bra_CC76_wait_next_death_anim_step
...
C - - - - - 0x000C84 00:CC74: F0 09     BEQ bra_CC7F_finish_death_anim_phase
; Wait until next death animation step timer
bra_CC76_wait_next_death_anim_step:		; was: bra_CC76
C - - - - - 0x000C86 00:CC76: 20 C9 DD  JSR sub_DDC9_blink_power_pellet_tiles
C - - - - - 0x000C89 00:CC79: 20 AB D9  JSR sub_D9AB_prepare_sprite_positions
C - - - - - 0x000C8C 00:CC7C: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000C91 00:CC81: D0 3C     BNE bra_CCBF_bootstrap_title_after_game_over
C - - - - - 0x000C93 00:CC83: C6 67     DEC ram_lives_p1
C - - - - - 0x000C95 00:CC85: D0 0D     BNE bra_CC94_prepare_next_spawn_alias
...
C - - - - - 0x000CA1 00:CC91: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000CAE 00:CC9E: F0 04     BEQ bra_CCA4_check_p1_lives_after_death
C - - - - - 0x000CB0 00:CCA0: A5 77     LDA ram_lives_p2
C - - - - - 0x000CB2 00:CCA2: D0 26     BNE bra_CCCA_swap_state_and_switch_player
...
C - - - - - 0x000CB6 00:CCA6: D0 3B     BNE bra_CCE3_return_gameplay_dispatch
C - - - - - 0x000CB8 00:CCA8: 85 69     STA ram_0069
C - - - - - 0x000CBA 00:CCAA: A5 46     LDA ram_current_player
C - - - - - 0x000CBC 00:CCAC: F0 11     BEQ bra_CCBF_bootstrap_title_after_game_over
...
C - - - - - 0x000CCD 00:CCBD: 10 F1     BPL bra_CCB0_swap_player_state_blocks_first_path
...
C - - - - - 0x000CD7 00:CCC7: 4C 68 C1  JMP loc_C168_main_frame_bootstrap
...
C - - - - - 0x000CE9 00:CCD9: 10 F1     BPL bra_CCCC_swap_player_state_blocks_second_path
...
C - - - - - 0x000CF3 00:CCE3: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000CF8 00:CCE8: D0 11     BNE bra_CCFB_stage_clear_flash_tick
...
C - - - - - 0x000D01 00:CCF1: D0 F9     BNE bra_CCEC_clear_actor_slots
C - - - - - 0x000D03 00:CCF3: E6 87     INC ram_0087
C - - - - - 0x000D05 00:CCF5: A9 01     LDA #$01
C - - - - - 0x000D07 00:CCF7: 85 32     STA ram_animation
C - - - - - 0x000D09 00:CCF9: D0 55     BNE bra_CD50_stage_clear_tail_entry    ; jmp
...
C - - - - - 0x000D0F 00:CCFF: D0 4F     BNE bra_CD50_stage_clear_tail_entry
C - - - - - 0x000D11 00:CD01: A2 00     LDX #$00
C - - - - - 0x000D13 00:CD03: A5 87     LDA ram_0087
C - - - - - 0x000D15 00:CD05: 29 01     AND #$01
C - - - - - 0x000D17 00:CD07: D0 02     BNE bra_CD0B_flash_packet_copy_entry
...
C - - - - - 0x000D3B 00:CD2B: F0 18     BEQ bra_CD45_start_intermission_script
C - - - - - 0x000D3D 00:CD2D: E6 87     INC ram_0087
C - - - - - 0x000D3F 00:CD2F: E6 87     INC ram_0087
C - - - - - 0x000D41 00:CD31: C9 04     CMP #$04
C - - - - - 0x000D43 00:CD33: F0 10     BEQ bra_CD45_start_intermission_script
C - - - - - 0x000D45 00:CD35: E6 87     INC ram_0087
C - - - - - 0x000D47 00:CD37: E6 87     INC ram_0087
C - - - - - 0x000D49 00:CD39: C9 08     CMP #$08
C - - - - - 0x000D4B 00:CD3B: F0 08     BEQ bra_CD45_start_intermission_script
C - - - - - 0x000D4D 00:CD3D: C9 0C     CMP #$0C
C - - - - - 0x000D4F 00:CD3F: F0 04     BEQ bra_CD45_start_intermission_script
C - - - - - 0x000D51 00:CD41: C9 10     CMP #$10
C - - - - - 0x000D53 00:CD43: D0 07     BNE bra_CD4C_start_next_round_script
...
C - - - - - 0x000D59 00:CD49: 4C 50 CD  JMP loc_CD50_stage_clear_tail
...
C D 2 - - - 0x000D60 00:CD50: 20 C9 DD  JSR sub_DDC9_blink_power_pellet_tiles
C - - - - - 0x000D63 00:CD53: 20 AB D9  JSR sub_D9AB_prepare_sprite_positions
C - - - - - 0x000D66 00:CD56: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000D73 00:CD63: F0 03     BEQ bra_CD68_build_game_over_sprites
C - - - - - 0x000D75 00:CD65: 4C EC CD  JMP loc_CDEC_game_over_tick
...
C - - - - - 0x000D82 00:CD72: D0 F8     BNE bra_CD6C_clear_oam_head
...
C - - - - - 0x000D9A 00:CD8A: BD 29 CE  LDA tbl_CE29_game_over_sprite_positions,X
C - - - - - 0x000D9D 00:CD8D: 85 02     STA ram_0002    ; spr_X
C - - - - - 0x000D9F 00:CD8F: BD 2A CE  LDA tbl_CE29_game_over_sprite_positions + $01,X
C - - - - - 0x000DA2 00:CD92: 85 03     STA ram_0003    ; spr_Y
C - - - - - 0x000DA4 00:CD94: A6 07     LDX ram_0007
C - - - - - 0x000DA6 00:CD96: BD 31 CE  LDA tbl_CE31_game_over_group_sizes,X
...
C - - - - - 0x000DB1 00:CDA1: BD 01 CE  LDA tbl_CE01_game_over_sprite_tiles,X
C - - - - - 0x000DB4 00:CDA4: C8        INY
C - - - - - 0x000DB5 00:CDA5: 91 00     STA (ram_0000),Y    ; 0761-07A1 (spr_T)
C - - - - - 0x000DB7 00:CDA7: BD 15 CE  LDA tbl_CE15_game_over_sprite_attrs,X
...
C - - - - - 0x000DCE 00:CDBE: D0 DB     BNE bra_CD9B_emit_game_over_group_sprites
...
C - - - - - 0x000DD8 00:CDC8: F0 0A     BEQ bra_CDD4_advance_game_over_group_counter
C - - - - - 0x000DDA 00:CDCA: A5 77     LDA ram_lives_p2
C - - - - - 0x000DDC 00:CDCC: D0 06     BNE bra_CDD4_advance_game_over_group_counter
C - - - - - 0x000DDE 00:CDCE: A5 04     LDA ram_0004
C - - - - - 0x000DE0 00:CDD0: C9 02     CMP #$02
C - - - - - 0x000DE2 00:CDD2: F0 18     BEQ bra_CDEC_game_over_tick_entry
...
C - - - - - 0x000DE6 00:CDD6: F0 04     BEQ bra_CDDC_check_two_player_game_over_layout
C - - - - - 0x000DE8 00:CDD8: 10 AE     BPL bra_CD88_build_next_game_over_group
C - - - - - 0x000DEA 00:CDDA: 30 10     BMI bra_CDEC_game_over_tick_entry    ; jmp
...
C - - - - - 0x000DEE 00:CDDE: F0 0C     BEQ bra_CDEC_game_over_tick_entry
C - - - - - 0x000DF0 00:CDE0: A5 46     LDA ram_current_player
C - - - - - 0x000DF2 00:CDE2: F0 A4     BEQ bra_CD88_build_next_game_over_group
C - - - - - 0x000DF4 00:CDE4: E6 05     INC ram_0005
C - - - - - 0x000DF6 00:CDE6: E6 05     INC ram_0005
C - - - - - 0x000DF8 00:CDE8: E6 05     INC ram_0005
C - - - - - 0x000DFA 00:CDEA: D0 9C     BNE bra_CD88_build_next_game_over_group   ; jmp
...
C - - - - - 0x000DFE 00:CDEE: D0 0E     BNE bra_CDFE_return_gameplay_dispatch
...
C - - - - - 0x000E09 00:CDF9: D0 F8     BNE bra_CDF3_clear_oam_tail
C - - - - - 0x000E0B 00:CDFB: 4C 94 CC  JMP loc_CC94_prepare_next_spawn
; Return to gameplay dispatcher during game-over timeout
bra_CDFE_return_gameplay_dispatch:		; was: bra_CDFE
C - - - - - 0x000E0E 00:CDFE: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x000E4B 00:CE3B: D0 FC     BNE bra_CE39_wait_nmi
...
C - - - - - 0x000E60 00:CE50: D0 F9     BNE bra_CE4B_clear_runtime_block
...
C - - - - - 0x000E67 00:CE57: D0 FA     BNE bra_CE53_clear_oam_all
...
C - - - - - 0x000E9F 00:CE8F: F0 02     BEQ bra_CE93_after_stage_increment_check
...
C - - - - - 0x000EA3 00:CE93: 20 80 D0  JSR sub_D080_fill_maze_attr_tables
C - - - - - 0x000EA6 00:CE96: 20 5C E2  JSR sub_E25C_decompress_and_upload_maze_layout
; Shared round-init tail (runs for fresh round and respawn)
bra_CE99_common_round_init_tail:		; was: bra_CE99
C - - - - - 0x000EA9 00:CE99: 20 79 E3  JSR sub_E379_draw_score_hud_live
C - - - - - 0x000EAC 00:CE9C: 20 FA CF  JSR sub_CFFA_fill_center_strip_tiles
C - - - - - 0x000EAF 00:CE9F: 20 CD E4  JSR sub_E4CD_draw_lives_icons
C - - - - - 0x000EB2 00:CEA2: 20 3B E5  JSR sub_E53B_draw_stage_fruit_history
C - - - - - 0x000EB5 00:CEA5: 20 7C E4  JSR sub_E47C_upload_hud_text_blocks
...
C - - - - - 0x000EBE 00:CEAE: 30 04     BMI bra_CEB4_stage_offset_ready
C - - - - - 0x000EC0 00:CEB0: 69 06     ADC #$06
C - - - - - 0x000EC2 00:CEB2: D0 F9     BNE bra_CEAD_calc_stage_table_offset
...
C - - - - - 0x000EC7 00:CEB7: BD 42 EB  LDA tbl_EB42_stage_param_index_stream,X
...
C - - - - - 0x000ECF 00:CEBF: 30 04     BMI bra_CEC5_param_block_base_ready
C - - - - - 0x000ED1 00:CEC1: 69 16     ADC #$16
C - - - - - 0x000ED3 00:CEC3: D0 F9     BNE bra_CEBE_calc_param_block_offset
...
C - - - - - 0x000ED8 00:CEC8: B9 CC EB  LDA tbl_EBCC_level_param_blocks_22bytes,Y
C - - - - - 0x000EDB 00:CECB: 95 9F     STA ram_009F,X
C - - - - - 0x000EDD 00:CECD: E8        INX
C - - - - - 0x000EDE 00:CECE: C8        INY
C - - - - - 0x000EDF 00:CECF: E0 16     CPX #$16
C - - - - - 0x000EE1 00:CED1: D0 F5     BNE bra_CEC8_copy_level_param_block
C - - - - - 0x000EE3 00:CED3: A6 00     LDX ram_0000
C - - - - - 0x000EE5 00:CED5: BD 42 EB  LDA tbl_EB42_stage_param_index_stream,X
...
C - - - - - 0x000EF0 00:CEE0: BD 3A EC  LDA tbl_EC3A_speed_timer_blocks_8bytes,X
...
C - - - - - 0x000EF5 00:CEE5: BD 3A EC  LDA tbl_EC3A_speed_timer_blocks_8bytes,X
...
C - - - - - 0x000EFF 00:CEEF: D0 F4     BNE bra_CEE5_copy_timer_block
C - - - - - 0x000F01 00:CEF1: E6 00     INC ram_0000
C - - - - - 0x000F03 00:CEF3: A6 00     LDX ram_0000
C - - - - - 0x000F05 00:CEF5: BD 42 EB  LDA tbl_EB42_stage_param_index_stream,X
C - - - - - 0x000F08 00:CEF8: 85 8C     STA ram_008C
C - - - - - 0x000F0A 00:CEFA: E6 00     INC ram_0000
C - - - - - 0x000F0C 00:CEFC: A6 00     LDX ram_0000
C - - - - - 0x000F0E 00:CEFE: BD 42 EB  LDA tbl_EB42_stage_param_index_stream,X
C - - - - - 0x000F11 00:CF01: 0A        ASL
C - - - - - 0x000F12 00:CF02: AA        TAX
C - - - - - 0x000F13 00:CF03: BD 5A EC  LDA tbl_EC5A_dot_counter_threshold_pairs,X
C - - - - - 0x000F16 00:CF06: 85 8D     STA ram_008D
C - - - - - 0x000F18 00:CF08: E8        INX
C - - - - - 0x000F19 00:CF09: BD 5A EC  LDA tbl_EC5A_dot_counter_threshold_pairs,X
C - - - - - 0x000F1C 00:CF0C: 85 8E     STA ram_008E
C - - - - - 0x000F1E 00:CF0E: E6 00     INC ram_0000
C - - - - - 0x000F20 00:CF10: A5 69     LDA ram_0069
C - - - - - 0x000F22 00:CF12: F0 24     BEQ bra_CF38_load_release_targets_from_table
C - - - - - 0x000F24 00:CF14: A2 0C     LDX #$0C
C - - - - - 0x000F26 00:CF16: A0 00     LDY #$00
C - - - - - 0x000F28 00:CF18: BD 68 EC  LDA tbl_EC74_release_target_special_case_quad - $0C,X
...
C - - - - - 0x000F3A 00:CF2A: 7D 68 EC  ADC tbl_EC74_release_target_special_case_quad - $0C,X
...
C - - - - - 0x000F44 00:CF34: D0 F1     BNE bra_CF27_adjust_release_targets_by_pellets
C - - - - - 0x000F46 00:CF36: F0 16     BEQ bra_CF4E_init_ghost_release_state    ; jmp
...
C - - - - - 0x000F4A 00:CF3A: BD 42 EB  LDA tbl_EB42_stage_param_index_stream,X
...
C - - - - - 0x000F52 00:CF42: BD 68 EC  LDA tbl_EC68_ghost_release_target_quads,X
...
C - - - - - 0x000F5C 00:CF4C: D0 F4     BNE bra_CF42_copy_release_target_quad
...
C - - - - - 0x000F6E 00:CF5E: F0 0C     BEQ bra_CF6C_release_queue_tail_start
...
C - - - - - 0x000F7A 00:CF6A: D0 F0     BNE bra_CF5C_fill_release_queue_active
...
C - - - - - 0x000F80 00:CF70: F0 08     BEQ bra_CF7A_finalize_round_runtime
...
C - - - - - 0x000F88 00:CF78: D0 F4     BNE bra_CF6E_clear_release_queue_tail
...
C - - - - - 0x000F92 00:CF82: BD 42 EB  LDA tbl_EB42_stage_param_index_stream,X
C - - - - - 0x000F95 00:CF85: 85 93     STA ram_0093
C - - - - - 0x000F97 00:CF87: E6 00     INC ram_0000
C - - - - - 0x000F99 00:CF89: A6 00     LDX ram_0000
C - - - - - 0x000F9B 00:CF8B: BD 42 EB  LDA tbl_EB42_stage_param_index_stream,X
...
C - - - - - 0x000FCA 00:CFBA: F0 02     BEQ bra_CFBE_select_hud_packet
...
C - - - - - 0x000FCE 00:CFBE: B9 4E D0  LDA tbl_D04E_hud_ppu_packets_by_player,Y
...
C - - - - - 0x000FD8 00:CFC8: D0 F4     BNE bra_CFBE_copy_hud_ppu_packet
...
C - - - - - 0x000FDC 00:CFCC: B9 42 D0  LDA tbl_D042_round_init_anim_and_sprite_attr_defaults,Y
C - - - - - 0x000FDF 00:CFCF: 99 32 00  STA ram_animation,Y     ; also ram_spr_pal
C - - - - - 0x000FE2 00:CFD2: C8        INY
C - - - - - 0x000FE3 00:CFD3: C0 0C     CPY #$0C
C - - - - - 0x000FE5 00:CFD5: D0 F5     BNE bra_CFCC_copy_anim_palette_defaults
...
C - - - - - 0x000FEE 00:CFDE: D0 05     BNE bra_CFE5_next_power_pellet_slot
...
C - - - - - 0x000FF8 00:CFE8: D0 EF     BNE bra_CFD9_normalize_power_pellet_tiles
...
C - - - - - 0x001007 00:CFF7: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x001010 00:D000: F0 02     BEQ bra_D004_center_strip_addr_ready
...
C - - - - - 0x001036 00:D026: D0 F9     BNE bra_D021_fill_center_strip_row_tiles
...
C - - - - - 0x00104F 00:D03F: D0 CD     BNE bra_D00E_fill_center_strip_rows
...
C - - - - - 0x0010A1 00:D091: B9 AF D0  LDA tbl_D0AF_maze_attribute_bytes,Y
C - - - - - 0x0010A4 00:D094: 8D 07 20  STA $2007
C - - - - - 0x0010A7 00:D097: C8        INY
C - - - - - 0x0010A8 00:D098: C0 40     CPY #$40
C - - - - - 0x0010AA 00:D09A: D0 F5     BNE bra_D091_copy_attr_block_loop
C - - - - - 0x0010AC 00:D09C: CA        DEX
C - - - - - 0x0010AD 00:D09D: F0 01     BEQ bra_D0A0_select_second_attr_table
...
C - - - - - 0x0010BD 00:D0AD: D0 E0     BNE bra_D08F_attr_table_pass_loop    ; jmp
...
C - - - - - 0x001125 00:D115: D0 F0     BNE bra_D107_apply_frightened_palette_phase
...
C - - - - - 0x00112B 00:D11B: B0 24     BCS bra_D141_release_and_fruit_tick
C - - - - - 0x00112D 00:D11D: A2 00     LDX #$00
C - - - - - 0x00112F 00:D11F: A5 8A     LDA ram_008A
C - - - - - 0x001131 00:D121: 29 08     AND #$08
C - - - - - 0x001133 00:D123: D0 02     BNE bra_D127_prepare_ppu_append_index
...
C - - - - - 0x00113F 00:D12F: D0 F8     BNE bra_D129_find_ppu_terminator
C - - - - - 0x001141 00:D131: 98        TYA
C - - - - - 0x001142 00:D132: D0 01     BNE bra_D135_append_frightened_cmd_if_empty
...
C - - - - - 0x001145 00:D135: BD 05 D2  LDA tbl_D205_frightened_palette_cmd,X
...
C - - - - - 0x00114F 00:D13F: D0 F4     BNE bra_D135_copy_frightened_palette_cmd
...
C - - - - - 0x001153 00:D143: D0 2F     BNE bra_D174_check_global_release_target
C - - - - - 0x001155 00:D145: A5 CF     LDA ram_00CF
C - - - - - 0x001157 00:D147: C9 FF     CMP #$FF
C - - - - - 0x001159 00:D149: F0 29     BEQ bra_D174_check_global_release_target
C - - - - - 0x00115B 00:D14B: E6 D1     INC ram_00D1
C - - - - - 0x00115D 00:D14D: A5 D1     LDA ram_00D1
C - - - - - 0x00115F 00:D14F: C9 3C     CMP #$3C
C - - - - - 0x001161 00:D151: D0 21     BNE bra_D174_check_global_release_target
C - - - - - 0x001163 00:D153: A9 00     LDA #$00
C - - - - - 0x001165 00:D155: 85 D1     STA ram_00D1
C - - - - - 0x001167 00:D157: C6 CF     DEC ram_00CF
C - - - - - 0x001169 00:D159: 10 19     BPL bra_D174_check_global_release_target
C - - - - - 0x00116B 00:D15B: E6 D0     INC ram_00D0
C - - - - - 0x00116D 00:D15D: A5 D0     LDA ram_00D0
C - - - - - 0x00116F 00:D15F: 29 01     AND #$01
C - - - - - 0x001171 00:D161: F0 07     BEQ bra_D16A_use_personal_release_timer
C - - - - - 0x001173 00:D163: 20 03 E0  JSR sub_E003_try_reverse_ghost_directions
C - - - - - 0x001176 00:D166: A9 0F     LDA #$0F
C - - - - - 0x001178 00:D168: D0 02     BNE bra_D16C_store_next_release_timer    ; jmp
...
C - - - - - 0x001186 00:D176: F0 1F     BEQ bra_D197_release_counter_update_entry
C - - - - - 0x001188 00:D178: 18        CLC
C - - - - - 0x001189 00:D179: 65 6A     ADC ram_pellet_cnt_p1
C - - - - - 0x00118B 00:D17B: C9 C0     CMP #$C0
C - - - - - 0x00118D 00:D17D: D0 18     BNE bra_D197_release_counter_update_entry
C - - - - - 0x00118F 00:D17F: 20 EB D1  JSR sub_D1EB_queue_next_ghost_release
...
C - - - - - 0x001198 00:D188: D0 08     BNE bra_D192_next_release_target_candidate
C - - - - - 0x00119A 00:D18A: E8        INX
C - - - - - 0x00119B 00:D18B: B5 8F     LDA ram_008F,X
C - - - - - 0x00119D 00:D18D: 85 D3     STA ram_00D3
C - - - - - 0x00119F 00:D18F: 4C 97 D1  JMP loc_D197_update_release_counters
...
C - - - - - 0x0011A5 00:D195: D0 EF     BNE bra_D186_find_matching_release_target
...
C - - - - - 0x0011AD 00:D19D: D0 13     BNE bra_D1B2_check_personal_release_targets
...
C - - - - - 0x0011B9 00:D1A9: D0 07     BNE bra_D1B2_check_personal_release_targets
C - - - - - 0x0011BB 00:D1AB: A9 00     LDA #$00
C - - - - - 0x0011BD 00:D1AD: 85 D5     STA ram_00D5
C - - - - - 0x0011BF 00:D1AF: 20 EB D1  JSR sub_D1EB_queue_next_ghost_release
...
C - - - - - 0x0011C6 00:D1B6: F0 17     BEQ bra_D1CF_update_fruit_visibility_timer
C - - - - - 0x0011C8 00:D1B8: B5 8D     LDA ram_008D,X
C - - - - - 0x0011CA 00:D1BA: C5 6A     CMP ram_pellet_cnt_p1
C - - - - - 0x0011CC 00:D1BC: D0 11     BNE bra_D1CF_update_fruit_visibility_timer
...
C - - - - - 0x0011E3 00:D1D3: F0 15     BEQ bra_D1EA_return
C - - - - - 0x0011E5 00:D1D5: C6 D8     DEC ram_fruit_timer_lo
C - - - - - 0x0011E7 00:D1D7: D0 11     BNE bra_D1EA_return
C - - - - - 0x0011E9 00:D1D9: A5 D7     LDA ram_fruit_timer_hi
C - - - - - 0x0011EB 00:D1DB: F0 07     BEQ bra_D1E4_hide_fruit_sprite
...
C - - - - - 0x0011FF 00:D1EF: D0 05     BNE bra_D1F6_advance_release_slot
...
C - - - - - 0x00120A 00:D1FA: D0 F1     BNE bra_D1ED_find_free_release_slot
...
C - - - - - 0x001221 00:D211: D0 01     BNE bra_D214_init_collision_scan
...
C - - - - - 0x001236 00:D226: D0 32     BNE bra_D25A_advance_collision_candidate
...
C - - - - - 0x00123E 00:D22E: B0 07     BCS bra_D237_abs_dx_subtract_alt
...
C - - - - - 0x001245 00:D235: B0 02     BCS bra_D239_check_dx_window
...
C - - - - - 0x00124B 00:D23B: B0 1D     BCS bra_D25A_advance_collision_candidate
...
C - - - - - 0x001255 00:D245: B0 07     BCS bra_D24E_abs_dy_subtract_alt
...
C - - - - - 0x00125C 00:D24C: B0 02     BCS bra_D250_check_dy_window
...
C - - - - - 0x001262 00:D252: B0 06     BCS bra_D25A_advance_collision_candidate
C - - - - - 0x001264 00:D254: 65 03     ADC ram_0003
C - - - - - 0x001266 00:D256: C9 05     CMP #$05
C - - - - - 0x001268 00:D258: 90 10     BCC bra_D26A_dispatch_collision_type
...
C - - - - - 0x001277 00:D267: D0 B9     BNE bra_D222_scan_collision_candidates
...
C - - - - - 0x00127C 00:D26C: F0 45     BEQ bra_D2B3_handle_fruit_collision
C - - - - - 0x00127E 00:D26E: A5 02     LDA ram_0002
C - - - - - 0x001280 00:D270: 25 88     AND ram_0088
C - - - - - 0x001282 00:D272: F0 2E     BEQ bra_D2A2_trigger_player_death
...
C - - - - - 0x00128A 00:D27A: B9 D7 D2  LDA tbl_D2D7_ghost_score_popup_tiles,Y
...
C - - - - - 0x001298 00:D288: B9 E7 D2  LDA tbl_D2E7_ghost_score_popup_lo,Y
C - - - - - 0x00129B 00:D28B: 85 DD     STA ram_00DD
C - - - - - 0x00129D 00:D28D: B9 E3 D2  LDA tbl_D2E3_ghost_score_popup_hi,Y
...
C - - - - - 0x0012AF 00:D29F: 4C 60 E0  JMP loc_E060_add_points_and_update_score_buffers
...
C - - - - - 0x0012C5 00:D2B5: F0 01     BEQ bra_D2B8_spawn_fruit_and_score
...
C - - - - - 0x0012D5 00:D2C5: B9 EB D2  LDA tbl_D2EB_fruit_score_hi,Y
C - - - - - 0x0012D8 00:D2C8: 85 DD     STA ram_00DD
C - - - - - 0x0012DA 00:D2CA: B9 F3 D2  LDA tbl_D2F3_fruit_score_lo,Y
C - - - - - 0x0012DD 00:D2CD: 85 DE     STA ram_00DE
C - - - - - 0x0012DF 00:D2CF: B9 DB D2  LDA tbl_D2DB_fruit_score_popup_tiles,Y
C - - - - - 0x0012E2 00:D2D2: 85 37     STA ram_animation + $05
C - - - - - 0x0012E4 00:D2D4: 4C 60 E0  JMP loc_E060_add_points_and_update_score_buffers
...
C - - - - - 0x00130D 00:D2FD: F0 03     BEQ bra_D302_handle_live_input
C - - - - - 0x00130F 00:D2FF: 4C 71 D4  JMP loc_D471_demo_direction_script
...
C - - - - - 0x001316 00:D306: F0 35     BEQ bra_D33D_fallback_to_current_direction
...
C - - - - - 0x00131C 00:D30C: 90 FC     BCC bra_D30A_decode_dpad_direction
C - - - - - 0x00131E 00:D30E: BD 6D D4  LDA tbl_D46D_dpad_to_direction,X
...
C - - - - - 0x00132A 00:D31A: D0 18     BNE bra_D334_validate_requested_direction
...
C - - - - - 0x001332 00:D322: D0 09     BNE bra_D32D_accept_turn_or_reverse
...
C - - - - - 0x00133B 00:D32B: D0 07     BNE bra_D334_validate_requested_direction
...
C - - - - - 0x001341 00:D331: 4C 41 D3  JMP loc_D341_select_speed_profile
...
C - - - - - 0x00134B 00:D33B: F0 04     BEQ bra_D341_select_speed_profile_entry
...
C - - - - - 0x001355 00:D345: D0 02     BNE bra_D349_choose_speed_from_tile
...
C - - - - - 0x00135E 00:D34E: F0 10     BEQ bra_D360_load_movement_delta    ; if power pellet (visible)
C - - - - - 0x001360 00:D350: C9 02     CMP #con_tile + $02
C - - - - - 0x001362 00:D352: F0 0C     BEQ bra_D360_load_movement_delta    ; if power pellet (not visible)
C - - - - - 0x001364 00:D354: CA        DEX
C - - - - - 0x001365 00:D355: CA        DEX
C - - - - - 0x001366 00:D356: C9 03     CMP #con_tile + $03
C - - - - - 0x001368 00:D358: F0 06     BEQ bra_D360_load_movement_delta    ; if normal pellet
C - - - - - 0x00136A 00:D35A: C9 09     CMP #con_tile + $09
C - - - - - 0x00136C 00:D35C: F0 02     BEQ bra_D360_load_movement_delta    ; if normal pellet (rare)
...
C - - - - - 0x00137C 00:D36C: B9 79 D3  LDA tbl_D379_pos_lo_update_handlers,Y
C - - - - - 0x00137F 00:D36F: 85 10     STA ram_indirect_jmp
C - - - - - 0x001381 00:D371: B9 7A D3  LDA tbl_D379_pos_lo_update_handlers + $01,Y
...
C - - - - - 0x001393 00:D383: D0 02     BNE bra_D387_move_negative_axis_lo    ; jmp
...
C - - - - - 0x0013A0 00:D390: B0 02     BCS bra_D394_fold_borrow_into_step_count
...
C - - - - - 0x0013A9 00:D399: 4C AF D3  JMP loc_D3AF_step_remaining_pixels



ofs_004_D39C_03_right:
C - - J - - 0x0013AC 00:D39C: A2 00     LDX #$00    ; obj_pos_X_lo
C - - - - - 0x0013AE 00:D39E: F0 02     BEQ bra_D3A2_move_positive_axis_lo    ; jmp
...
C - - - - - 0x0013C1 00:D3B1: 10 01     BPL bra_D3B4_dispatch_pos_hi_update
...
C - - - - - 0x0013C8 00:D3B8: B9 C5 D3  LDA tbl_D3C5_pos_hi_update_handlers,Y
C - - - - - 0x0013CB 00:D3BB: 85 10     STA ram_indirect_jmp
C - - - - - 0x0013CD 00:D3BD: B9 C6 D3  LDA tbl_D3C5_pos_hi_update_handlers + $01,Y
...
C - - - - - 0x0013E5 00:D3D5: D0 06     BNE bra_D3DD_move_positive_axis_hi    ; jmp
...
C - - - - - 0x0013F6 00:D3E6: D0 44     BNE bra_D42C_apply_tunnel_wrap_and_turn
...
C - - - - - 0x0013FF 00:D3EF: F0 3B     BEQ bra_D42C_apply_tunnel_wrap_and_turn
...
C - - - - - 0x001409 00:D3F9: D0 31     BNE bra_D42C_apply_tunnel_wrap_and_turn    ; jmp
...
C - - - - - 0x001413 00:D403: D0 08     BNE bra_D40D_move_negative_axis_hi    ; jmp
...
C - - - - - 0x001426 00:D416: F0 14     BEQ bra_D42C_apply_tunnel_wrap_and_turn
...
C - - - - - 0x00142F 00:D41F: F0 0B     BEQ bra_D42C_apply_tunnel_wrap_and_turn
...
C - - - - - 0x001440 00:D430: 90 0A     BCC bra_D43C_set_tunnel_palette
; 18-FF
C - - - - - 0x001442 00:D432: C9 A9     CMP #$A9
C - - - - - 0x001444 00:D434: B0 06     BCS bra_D43C_set_tunnel_palette    ; if A9-FF
; 18-A8
C - - - - - 0x001446 00:D436: A5 38     LDA ram_spr_pal
C - - - - - 0x001448 00:D438: 29 DF     AND #$DF
C - - - - - 0x00144A 00:D43A: 90 04     BCC bra_D440_store_pacman_palette    ; jmp
...
C - - - - - 0x001456 00:D446: B0 06     BCS bra_D44E_check_right_wrap
C - - - - - 0x001458 00:D448: A9 BF     LDA #$BF
C - - - - - 0x00145A 00:D44A: 85 1A     STA ram_obj_pos_X_hi
C - - - - - 0x00145C 00:D44C: D0 08     BNE bra_D456_try_apply_queued_turn    ; jmp
; Check right-edge wrap condition
bra_D44E_check_right_wrap:		; was: bra_D44E
C - - - - - 0x00145E 00:D44E: C9 C0     CMP #$C0
C - - - - - 0x001460 00:D450: 90 04     BCC bra_D456_try_apply_queued_turn
...
C - - - - - 0x00146C 00:D45C: D0 0C     BNE bra_D46A_continue_step_loop
C - - - - - 0x00146E 00:D45E: A5 50     LDA ram_direction_1
C - - - - - 0x001470 00:D460: C5 51     CMP ram_direction_2
C - - - - - 0x001472 00:D462: F0 06     BEQ bra_D46A_continue_step_loop
...
C - - - - - 0x00147A 00:D46A: 4C AF D3  JMP loc_D3AF_step_remaining_pixels
...
C - - - - - 0x001485 00:D475: D0 0B     BNE bra_D482_apply_demo_direction
C - - - - - 0x001487 00:D477: E6 E4     INC ram_00E4
C - - - - - 0x001489 00:D479: E6 E4     INC ram_00E4
C - - - - - 0x00148B 00:D47B: A4 E4     LDY ram_00E4
C - - - - - 0x00148D 00:D47D: B9 8A D4  LDA tbl_D48A_demo_direction_timing_pairs,Y
...
C - - - - - 0x001492 00:D482: B9 8B D4  LDA tbl_D48A_demo_direction_timing_pairs + $01,Y
C - - - - - 0x001495 00:D485: 29 03     AND #$03
C - - - - - 0x001497 00:D487: 4C 11 D3  JMP loc_D311_apply_requested_direction
...
C - - - - - 0x0014E8 00:D4D8: 20 F2 D4  JSR sub_D4F2_dispatch_ghost_state_handler
...
C - - - - - 0x0014FF 00:D4EF: D0 E7     BNE bra_D4D8_update_ghost_slot_loop
...
C - - - - - 0x001504 00:D4F4: B9 01 D5  LDA tbl_D501_ghost_state_handlers,Y
C - - - - - 0x001507 00:D4F7: 85 10     STA ram_indirect_jmp
C - - - - - 0x001509 00:D4F9: B9 02 D5  LDA tbl_D501_ghost_state_handlers + $01,Y
...
- D 2 - - - 0x001511 00:D501: 40 D8     .word ofs_006_D840_state00_enter_house
- D 2 - - - 0x001513 00:D503: F0 D7     .word ofs_006_D7F0_state02_exit_house
- D 2 - - - 0x001515 00:D505: 0C D5     .word ofs_006_D50C_state04_move_logic
- D 2 - - - 0x001517 00:D507: 0C D5     .word ofs_006_D50C_state06_move_logic
- - - - - - 0x001519 00:D509: 0B D5     .word ofs_006_D50B_state08_noop
...
C - - J - - 0x00151C 00:D50C: 20 8C D7  JSR sub_D78C_select_ghost_speed_vector
C - - - - - 0x00151F 00:D50F: B5 B9     LDA ram_00B9,X
C - - - - - 0x001521 00:D511: 0A        ASL
C - - - - - 0x001522 00:D512: A8        TAY
C - - - - - 0x001523 00:D513: B9 20 D5  LDA tbl_D520_axis_step_lo_handlers,Y
C - - - - - 0x001526 00:D516: 85 10     STA ram_indirect_jmp
C - - - - - 0x001528 00:D518: B9 21 D5  LDA tbl_D520_axis_step_lo_handlers + $01,Y
...
- D 2 - - - 0x001530 00:D520: 3E D5     .word ofs_007_D53E_step_lo_neg_axis
- D 2 - - - 0x001532 00:D522: 42 D5     .word ofs_007_D542_step_lo_neg_axis_alt
- D 2 - - - 0x001534 00:D524: 28 D5     .word ofs_007_D528_step_lo_pos_axis
- D 2 - - - 0x001536 00:D526: 2C D5     .word ofs_007_D52C_step_lo_pos_axis_alt
...
C - - - - - 0x00153A 00:D52A: D0 02     BNE bra_D52E_apply_lo_step_add    ; jmp
...
C - - - - - 0x00154B 00:D53B: 4C 56 D5  JMP loc_D556_step_hi_budget_loop
...
C - - - - - 0x001550 00:D540: D0 02     BNE bra_D544_apply_lo_step_sub    ; jmp
...
C - - - - - 0x00155D 00:D54D: B0 02     BCS bra_D551_fold_borrow_into_hi_steps
...
C - - - - - 0x001568 00:D558: 10 01     BPL bra_D55B_dispatch_hi_axis_step
...
C - - - - - 0x00156F 00:D55F: B9 6C D5  LDA tbl_D56C_axis_step_hi_handlers,Y
C - - - - - 0x001572 00:D562: 85 10     STA ram_indirect_jmp
C - - - - - 0x001574 00:D564: B9 6D D5  LDA tbl_D56C_axis_step_hi_handlers + $01,Y
...
- D 2 - - - 0x00157C 00:D56C: 74 D5     .word ofs_008_D574_hi_step_neg_y
- D 2 - - - 0x00157E 00:D56E: 88 D5     .word ofs_008_D588_hi_step_neg_x
- D 2 - - - 0x001580 00:D570: 7A D5     .word ofs_008_D57A_hi_step_pos_y
- D 2 - - - 0x001582 00:D572: 82 D5     .word ofs_008_D582_hi_step_pos_x
...
C - - - - - 0x001588 00:D578: D0 04     BNE bra_D57E_prepare_y_axis_update    ; jmp
...
C - - - - - 0x001590 00:D580: D0 0C     BNE bra_D58E_apply_hi_axis_delta    ; jmp
...
C - - - - - 0x001596 00:D586: D0 04     BNE bra_D58C_prepare_x_axis_update    ; jmp
...
C - - - - - 0x0015E4 00:D5D4: F0 03     BEQ bra_D5D9_check_house_entry_trigger
C - - - - - 0x0015E6 00:D5D6: 4C 56 D5  JMP loc_D556_step_hi_budget_loop
...
C - - - - - 0x0015EF 00:D5DF: D0 25     BNE bra_D606_handle_state06_targeting
...
C - - - - - 0x0015F7 00:D5E7: D0 1D     BNE bra_D606_handle_state06_targeting
...
C - - - - - 0x00161A 00:D60A: D0 0B     BNE bra_D617_select_target_mode
...
C - - - - - 0x001624 00:D614: 4C E3 D6  JMP loc_D6E3_choose_next_direction
...
C - - - - - 0x00162B 00:D61B: D0 58     BNE bra_D675_pick_turn_from_tile_options
C - - - - - 0x00162D 00:D61D: A5 04     LDA ram_0004
C - - - - - 0x00162F 00:D61F: 25 87     AND ram_0087
C - - - - - 0x001631 00:D621: D0 17     BNE bra_D63A_dispatch_target_formula
C - - - - - 0x001633 00:D623: 8A        TXA
C - - - - - 0x001634 00:D624: A8        TAY
C - - - - - 0x001635 00:D625: B9 32 D6  LDA tbl_D632_corner_targets,Y
C - - - - - 0x001638 00:D628: 85 CD     STA ram_00CD
C - - - - - 0x00163A 00:D62A: B9 33 D6  LDA tbl_D632_corner_targets + $01,Y
C - - - - - 0x00163D 00:D62D: 85 CE     STA ram_00CE
C - - - - - 0x00163F 00:D62F: 4C E3 D6  JMP loc_D6E3_choose_next_direction
...
C - - - - - 0x00164C 00:D63C: B9 49 D6  LDA tbl_D649_target_formula_handlers,Y
C - - - - - 0x00164F 00:D63F: 85 10     STA ram_indirect_jmp
C - - - - - 0x001651 00:D641: B9 4A D6  LDA tbl_D649_target_formula_handlers + $01,Y
...
- D 2 - - - 0x001659 00:D649: A6 D6     .word ofs_009_D6A6_target_formula_slot0
- D 2 - - - 0x00165B 00:D64B: B0 D6     .word ofs_009_D6B0_target_formula_slot1
- D 2 - - - 0x00165D 00:D64D: CF D6     .word ofs_009_D6CF_target_formula_slot2
- D 2 - - - 0x00165F 00:D64F: 51 D6     .word ofs_009_D651_target_formula_slot3
...
C - - - - - 0x001666 00:D656: B0 07     BCS bra_D65F_check_target_dx_window
...
C - - - - - 0x001671 00:D661: B0 43     BCS bra_D6A6_use_player_position_target
C - - - - - 0x001673 00:D663: A5 1C     LDA ram_obj_pos_Y_hi
C - - - - - 0x001675 00:D665: 38        SEC
C - - - - - 0x001676 00:D666: E5 2C     SBC ram_obj_pos_Y_hi + $10
C - - - - - 0x001678 00:D668: B0 07     BCS bra_D671_check_target_dy_window
...
C - - - - - 0x001683 00:D673: B0 31     BCS bra_D6A6_use_player_position_target
...
C - - - - - 0x00168F 00:D67F: D0 04     BNE bra_D685_try_next_exit_seed
C - - - - - 0x001691 00:D681: A9 02     LDA #$02
C - - - - - 0x001693 00:D683: D0 1C     BNE bra_D6A1_store_selected_direction    ; jmp
...
C - - - - - 0x0016A0 00:D690: D0 EB     BNE bra_D67D_scan_open_exits
...
C - - - - - 0x0016AB 00:D69B: F0 E0     BEQ bra_D67D_scan_open_exits
...
C - - - - - 0x0016B3 00:D6A3: 4C 56 D5  JMP loc_D556_step_hi_budget_loop
...
C - - - - - 0x0016BE 00:D6AE: D0 33     BNE bra_D6E3_choose_next_direction
...
C - - - - - 0x0016F9 00:D6E9: B9 EC D7  LDA tbl_D7EC_forbidden_turn_mask_by_state,Y
C - - - - - 0x0016FC 00:D6EC: 85 0A     STA ram_000A
C - - - - - 0x0016FE 00:D6EE: B9 ED D7  LDA tbl_D7EC_forbidden_turn_mask_by_state + $01,Y
C - - - - - 0x001701 00:D6F1: 85 0B     STA ram_000B
C - - - - - 0x001703 00:D6F3: 20 2B E4  JSR sub_E42B_collect_valid_turn_candidates
C - - - - - 0x001706 00:D6F6: A5 0C     LDA ram_000C
C - - - - - 0x001708 00:D6F8: C9 FF     CMP #$FF
C - - - - - 0x00170A 00:D6FA: D0 04     BNE bra_D700_check_candidate_b
C - - - - - 0x00170C 00:D6FC: A9 02     LDA #$02
C - - - - - 0x00170E 00:D6FE: D0 08     BNE bra_D708_commit_direction_choice    ; jmp
...
C - - - - - 0x001714 00:D704: D0 05     BNE bra_D70B_rank_direction_candidates
...
C - - - - - 0x001724 00:D714: B0 0F     BCS bra_D725_store_abs_dx
...
C - - - - - 0x00173E 00:D72E: B0 0B     BCS bra_D73B_store_abs_dy
...
C - - - - - 0x001751 00:D741: B0 02     BCS bra_D745_prepare_candidate_pair_scan
...
C - - - - - 0x001760 00:D750: B9 DC D7  LDA tbl_D7DC_ranked_dir_order_lut,Y
...
C - - - - - 0x001768 00:D758: F0 AE     BEQ bra_D708_commit_direction_choice
C - - - - - 0x00176A 00:D75A: C8        INY
C - - - - - 0x00176B 00:D75B: C0 04     CPY #$04
C - - - - - 0x00176D 00:D75D: D0 F6     BNE bra_D755_match_candidate_against_valid
C - - - - - 0x00176F 00:D75F: E6 05     INC ram_0005
C - - - - - 0x001771 00:D761: C6 06     DEC ram_0006
C - - - - - 0x001773 00:D763: D0 E9     BNE bra_D74E_try_ranked_direction
...
C - - - - - 0x001781 00:D771: F0 95     BEQ bra_D708_commit_direction_choice
C - - - - - 0x001783 00:D773: C8        INY
C - - - - - 0x001784 00:D774: C0 04     CPY #$04
C - - - - - 0x001786 00:D776: D0 F6     BNE bra_D76E_try_turn_left_alt
...
C - - - - - 0x001794 00:D784: F0 82     BEQ bra_D708_commit_direction_choice
C - - - - - 0x001796 00:D786: C8        INY
C - - - - - 0x001797 00:D787: C0 04     CPY #$04
C - - - - - 0x001799 00:D789: D0 F6     BNE bra_D781_try_turn_right_alt
...
C - - - - - 0x0017A0 00:D790: F0 41     BEQ bra_D7D3_apply_eyes_speed
...
C - - - - - 0x0017A8 00:D798: D0 15     BNE bra_D7AF_select_scatter_or_chase_speed
...
C - - - - - 0x0017B0 00:D7A0: B0 04     BCS bra_D7A6_apply_tunnel_speed
C - - - - - 0x0017B2 00:D7A2: C9 30     CMP #$30
C - - - - - 0x0017B4 00:D7A4: B0 09     BCS bra_D7AF_select_scatter_or_chase_speed
...
C - - - - - 0x0017C3 00:D7B3: D0 15     BNE bra_D7CA_apply_frightened_speed
C - - - - - 0x0017C5 00:D7B5: 8A        TXA
C - - - - - 0x0017C6 00:D7B6: D0 09     BNE bra_D7C1_apply_normal_speed_slots12
...
C - - - - - 0x00180D 00:D7FD: F0 1E     BEQ bra_D81D_transition_to_state04
C - - - - - 0x00180F 00:D7FF: 90 06     BCC bra_D807_choose_exit_left_or_up
C - - - - - 0x001811 00:D801: C6 05     DEC ram_0005
C - - - - - 0x001813 00:D803: A9 01     LDA #$01
C - - - - - 0x001815 00:D805: D0 02     BNE bra_D809_store_exit_direction    ; jmp
...
C - - - - - 0x001844 00:D834: F0 01     BEQ bra_D837_finish_exit_house_transition
...
C - - - - - 0x00185A 00:D84A: B9 57 D8  LDA tbl_D857_house_transition_handlers,Y
C - - - - - 0x00185D 00:D84D: 85 10     STA ram_indirect_jmp
C - - - - - 0x00185F 00:D84F: B9 58 D8  LDA tbl_D857_house_transition_handlers + $01,Y
...
- D 2 - - - 0x001867 00:D857: 5B D8     .word ofs_010_D85B_house_move_up_phase
- D 2 - - - 0x001869 00:D859: 5D D8     .word ofs_010_D85D_house_move_down_phase
...
C - - - - - 0x001880 00:D870: B0 04     BCS bra_D876_check_house_transition_bounds
C - - - - - 0x001882 00:D872: A9 02     LDA #$02
C - - - - - 0x001884 00:D874: D0 06     BNE bra_D87C_store_house_transition_phase    ; jmp
; Check house transition bounds
bra_D876_check_house_transition_bounds:		; was: bra_D876
C - - - - - 0x001886 00:D876: C9 70     CMP #$70
C - - - - - 0x001888 00:D878: 90 04     BCC bra_D87E_return
...
C - - - - - 0x0018A5 00:D895: 20 AF D8  JSR sub_D8AF_dispatch_state06_only_handler
...
C - - - - - 0x0018BC 00:D8AC: D0 E7     BNE bra_D895_update_state06_slot_loop
...
C - - - - - 0x0018C1 00:D8B1: B9 BE D8  LDA tbl_D8BE_state06_only_handlers,Y
C - - - - - 0x0018C4 00:D8B4: 85 10     STA ram_indirect_jmp
C - - - - - 0x0018C6 00:D8B6: B9 BF D8  LDA tbl_D8BE_state06_only_handlers + $01,Y
...
- D 2 - - - 0x0018CE 00:D8BE: C8 D8     .word ofs_006_D8C8_state00_noop
- D 2 - - - 0x0018D0 00:D8C0: C8 D8     .word ofs_006_D8C8_state02_noop
- D 2 - - - 0x0018D2 00:D8C2: C8 D8     .word ofs_006_D8C8_state04_noop
- D 2 - - - 0x0018D4 00:D8C4: 0C D5     .word ofs_006_D50C_state06_move_logic
- D 2 - - - 0x0018D6 00:D8C6: C8 D8     .word ofs_006_D8C8_state08_noop
...
C - - - - - 0x0018E1 00:D8D1: D0 04     BNE bra_D8D7_next_slot_for_state06_scan
...
C - - - - - 0x0018EB 00:D8DB: D0 F0     BNE bra_D8CD_scan_state06_presence
C - - - - - 0x0018ED 00:D8DD: A5 88     LDA ram_0088
C - - - - - 0x0018EF 00:D8DF: F0 04     BEQ bra_D8E5_set_release_marker_by_pellets
...
C - - - - - 0x0018FB 00:D8EB: B0 06     BCS bra_D8F3_commit_release_marker
C - - - - - 0x0018FD 00:D8ED: C8        INY
C - - - - - 0x0018FE 00:D8EE: C9 42     CMP #$42
C - - - - - 0x001900 00:D8F0: B0 01     BCS bra_D8F3_commit_release_marker
...
C - - - - - 0x001917 00:D907: D0 10     BNE bra_D919_advance_anim_phase_counter
...
C - - - - - 0x001920 00:D910: F0 07     BEQ bra_D919_advance_anim_phase_counter
C - - - - - 0x001922 00:D912: A5 B7     LDA ram_00B7
C - - - - - 0x001924 00:D914: 29 03     AND #$03
C - - - - - 0x001926 00:D916: 4C 1D D9  JMP loc_D91D_build_anim_frame_index
...
C - - - - - 0x001931 00:D921: 90 04     BCC bra_D927_use_anim_phase_lut
C - - - - - 0x001933 00:D923: A9 01     LDA #$01
C - - - - - 0x001935 00:D925: D0 07     BNE bra_D92E_store_anim_frame    ; jmp
; Use animation phase LUT
bra_D927_use_anim_phase_lut:		; was: bra_D927
C - - - - - 0x001937 00:D927: A8        TAY
C - - - - - 0x001938 00:D928: B9 31 D9  LDA tbl_D931_pacman_anim_phase_lut,Y
...
C - - - - - 0x001950 00:D940: F0 04     BEQ bra_D946_init_anim_phase_offset
...
C - - - - - 0x00195A 00:D94A: 20 56 D9  JSR sub_D956_dispatch_ghost_anim_handler
C - - - - - 0x00195D 00:D94D: 06 01     ASL ram_0001
C - - - - - 0x00195F 00:D94F: E8        INX
C - - - - - 0x001960 00:D950: E8        INX
C - - - - - 0x001961 00:D951: E0 08     CPX #$08
C - - - - - 0x001963 00:D953: D0 F5     BNE bra_D94A_update_ghost_anim_slot_loop
...
C - - - - - 0x001968 00:D958: B9 65 D9  LDA tbl_D965_ghost_anim_handlers,Y
C - - - - - 0x00196B 00:D95B: 85 10     STA ram_indirect_jmp
C - - - - - 0x00196D 00:D95D: B9 66 D9  LDA tbl_D965_ghost_anim_handlers + $01,Y
...
- D 2 - - - 0x001975 00:D965: 8C D9     .word ofs_011_D98C_state00_anim_default
- D 2 - - - 0x001977 00:D967: 8C D9     .word ofs_011_D98C_state02_anim_default
- D 2 - - - 0x001979 00:D969: 8C D9     .word ofs_011_D98C_state04_anim_default
- D 2 - - - 0x00197B 00:D96B: 98 D9     .word ofs_011_D998_state06_anim_eyes
- D 2 - - - 0x00197D 00:D96D: 55 D9     .word ofs_011_D955_state07_anim_noop
...
C - - - - - 0x001987 00:D977: 30 05     BMI bra_D97E_apply_anim_phase_offset
C - - - - - 0x001989 00:D979: 18        CLC
C - - - - - 0x00198A 00:D97A: 69 02     ADC #$02
C - - - - - 0x00198C 00:D97C: D0 F7     BNE bra_D975_accumulate_anim_frame_offset
...
C - - - - - 0x0019A0 00:D990: F0 DD     BEQ bra_D96F_build_anim_frame_from_direction
C - - - - - 0x0019A2 00:D992: A9 1E     LDA #$1E
C - - - - - 0x0019A4 00:D994: 85 02     STA ram_0002
C - - - - - 0x0019A6 00:D996: D0 E6     BNE bra_D97E_apply_anim_phase_offset    ; jmp
...
C - - - - - 0x0019B0 00:D9A0: 30 05     BMI bra_D9A7_store_eyes_anim_offset
C - - - - - 0x0019B2 00:D9A2: 18        CLC
C - - - - - 0x0019B3 00:D9A3: 69 01     ADC #$01
C - - - - - 0x0019B5 00:D9A5: D0 F7     BNE bra_D99E_accumulate_eyes_anim_offset    ; jmp
; Store eyes animation offset
bra_D9A7_store_eyes_anim_offset:		; was: bra_D9A7
C - - - - - 0x0019B7 00:D9A7: 85 02     STA ram_0002
C - - - - - 0x0019B9 00:D9A9: 30 D8     BMI bra_D983_store_ghost_anim_frame    ; jmp
...
C - - - - - 0x0019C3 00:D9B3: 10 F8     BPL bra_D9AD_copy_obj_to_sprite_pos
...
C - - - - - 0x0019D9 00:D9C9: D0 7B     BNE bra_DA46_next_overlap_candidate
...
C - - - - - 0x0019E2 00:D9D2: B0 08     BCS bra_D9DC_abs_dx_alt
...
C - - - - - 0x0019EA 00:D9DA: B0 02     BCS bra_D9DE_check_overlap_dx
...
C - - - - - 0x0019F0 00:D9E0: B0 64     BCS bra_DA46_next_overlap_candidate
...
C - - - - - 0x0019FB 00:D9EB: B0 08     BCS bra_D9F5_abs_dy_alt
...
C - - - - - 0x001A03 00:D9F3: B0 02     BCS bra_D9F7_check_overlap_dy
...
C - - - - - 0x001A09 00:D9F9: B0 4B     BCS bra_DA46_next_overlap_candidate
C - - - - - 0x001A0B 00:D9FB: 65 04     ADC ram_0004
C - - - - - 0x001A0D 00:D9FD: C9 10     CMP #$10
C - - - - - 0x001A0F 00:D9FF: B0 45     BCS bra_DA46_next_overlap_candidate
...
C - - - - - 0x001A53 00:DA43: 4C 56 DA  JMP loc_DA56_finalize_positions
...
C - - - - - 0x001A61 00:DA51: 30 03     BMI bra_DA56_finalize_positions
C - - - - - 0x001A63 00:DA53: 4C C5 D9  JMP loc_D9C5_overlap_resolution_loop
...
C D 2 - - - 0x001A66 00:DA56: 20 54 E1  JSR sub_E154_build_object_neighbor_ppu_positions
C - - - - - 0x001A69 00:DA59: 4C 5C DA  JMP loc_DA5C_build_oam_from_sprite_buffers
...
C - - - - - 0x001A89 00:DA79: D0 04     BNE bra_DA7F_apply_y_offset
C - - - - - 0x001A8B 00:DA7B: A9 FF     LDA #$FF
C - - - - - 0x001A8D 00:DA7D: D0 04     BNE bra_DA83_store_oam_y    ; jmp
; Apply Y offset from sprite offset table
bra_DA7F_apply_y_offset:		; was: bra_DA7F
C - - - - - 0x001A8F 00:DA7F: 18        CLC
C - - - - - 0x001A90 00:DA80: 7D C1 DD  ADC tbl_DDC1_oam_quad_offsets,X
...
C - - - - - 0x001AA1 00:DA91: F0 29     BEQ bra_DABC_compose_sprite_set0
C - - - - - 0x001AA3 00:DA93: C9 02     CMP #$02
C - - - - - 0x001AA5 00:DA95: F0 6B     BEQ bra_DB02_compose_sprite_set2
C - - - - - 0x001AA7 00:DA97: 90 46     BCC bra_DADF_compose_sprite_set1
; 03
...
- - - - - - 0x001AB4 00:DAA4: B9 8D DC  LDA tbl_DC8D_actor_sprite_attrs,Y
...
- - - - - - 0x001AC2 00:DAB2: 19 C1 DD  ORA tbl_DDC1_oam_quad_offsets,Y
- - - - - - 0x001AC5 00:DAB5: A0 02     LDY #$02
- - - - - - 0x001AC7 00:DAB7: 91 02     STA (ram_0002),Y
- - - - - - 0x001AC9 00:DAB9: 4C 22 DB  JMP loc_DB22_write_oam_quad_x_pass
...
C - - - - - 0x001AD7 00:DAC7: B9 59 DB  LDA tbl_DB59_actor_sprite_tiles,Y
...
C - - - - - 0x001AE5 00:DAD5: 19 8D DC  ORA tbl_DC8D_actor_sprite_attrs,Y
C - - - - - 0x001AE8 00:DAD8: A0 02     LDY #$02
C - - - - - 0x001AEA 00:DADA: 91 02     STA (ram_0002),Y    ; 0702-075E (spr_A)
C - - - - - 0x001AEC 00:DADC: 4C 22 DB  JMP loc_DB22_write_oam_quad_x_pass
...
C - - - - - 0x001AFA 00:DAEA: B9 59 DC  LDA tbl_DC59_actor_alt_sprite_tiles,Y
...
C - - - - - 0x001B08 00:DAF8: 19 8D DD  ORA tbl_DD8D_actor_alt_sprite_attrs,Y
C - - - - - 0x001B0B 00:DAFB: A0 02     LDY #$02
C - - - - - 0x001B0D 00:DAFD: 91 02     STA (ram_0002),Y    ; 0702-072E and 0742-074E (spr_A)
C - - - - - 0x001B0F 00:DAFF: 4C 22 DB  JMP loc_DB22_write_oam_quad_x_pass
...
- - - - - - 0x001B1D 00:DB0D: B9 8D DC  LDA tbl_DC8D_actor_sprite_attrs,Y
...
- - - - - - 0x001B2B 00:DB1B: 19 C1 DD  ORA tbl_DDC1_oam_quad_offsets,Y
...
C - - - - - 0x001B36 00:DB26: D0 04     BNE bra_DB2C_apply_x_offset
C - - - - - 0x001B38 00:DB28: A9 FF     LDA #$FF
C - - - - - 0x001B3A 00:DB2A: D0 04     BNE bra_DB30_store_oam_x    ; jmp
; Apply X offset from sprite offset table
bra_DB2C_apply_x_offset:		; was: bra_DB2C
C - - - - - 0x001B3C 00:DB2C: 18        CLC
C - - - - - 0x001B3D 00:DB2D: 7D C2 DD  ADC tbl_DDC1_oam_quad_offsets + $01,X
...
C - - - - - 0x001B51 00:DB41: F0 03     BEQ bra_DB46_next_sprite_group_or_done
C - - - - - 0x001B53 00:DB43: 4C 75 DA  JMP loc_DA75_build_oam_quad_loop
...
C - - - - - 0x001B63 00:DB53: F0 03     BEQ bra_DB58_return
C - - - - - 0x001B65 00:DB55: 4C 70 DA  JMP loc_DA70_next_sprite_group
...
C - - - - - 0x001DDD 00:DDCD: F0 01     BEQ bra_DDD0_process_blink_step
...
C - - - - - 0x001DE5 00:DDD5: F0 0A     BEQ bra_DDE1_store_power_pellet_tile
C - - - - - 0x001DE7 00:DDD7: C9 01     CMP #con_tile + $01
C - - - - - 0x001DE9 00:DDD9: D0 04     BNE bra_DDDF_set_power_pellet_visible
C - - - - - 0x001DEB 00:DDDB: A9 02     LDA #con_tile + $02
C - - - - - 0x001DED 00:DDDD: D0 02     BNE bra_DDE1_store_power_pellet_tile    ; jmp
...
C - - - - - 0x001DF6 00:DDE6: D0 E9     BNE bra_DDD1_toggle_next_power_pellet_tile
...
C - - - - - 0x001DFB 00:DDEB: F0 03     BEQ bra_DDF0_flush_score_hud_buffers
C - - - - - 0x001DFD 00:DDED: 4C 7E DE  JMP loc_DE7E_flush_power_pellet_and_main_ppu
...
C - - - - - 0x001E05 00:DDF5: F0 53     BEQ bra_DE4A_update_1up_blink    ; skip if buffer is empty
...
C - - - - - 0x001E21 00:DE11: D0 F5     BNE bra_DE08_write_score_digits
...
C - - - - - 0x001E32 00:DE22: F0 26     BEQ bra_DE4A_update_1up_blink    ; skip if buffer is empty
...
C - - - - - 0x001E4E 00:DE3E: D0 F5     BNE bra_DE35_write_hiscore_digits
...
C - - - - - 0x001E5E 00:DE4E: D0 2E     BNE bra_DE7E_flush_power_pellet_and_main_ppu
...
C - - - - - 0x001E75 00:DE65: F0 0D     BEQ bra_DE74_clear_1up_text
...
C - - - - - 0x001E80 00:DE70: D0 F5     BNE bra_DE67_write_1up_text
C - - - - - 0x001E82 00:DE72: F0 0A     BEQ bra_DE7E_flush_power_pellet_and_main_ppu    ; jmp
...
C - - - - - 0x001E8C 00:DE7C: D0 F8     BNE bra_DE76_write_1up_clear_tiles
...
C - - - - - 0x001E96 00:DE86: F0 02     BEQ bra_DE8A_select_player_nametable
...
C - - - - - 0x001E9D 00:DE8D: B9 CF DE  LDA tbl_DECF_power_pellet_ppu_addrs,Y
C - - - - - 0x001EA0 00:DE90: 8D 06 20  STA $2006
C - - - - - 0x001EA3 00:DE93: B9 D0 DE  LDA tbl_DECF_power_pellet_ppu_addrs + $01,Y
...
C - - - - - 0x001EB3 00:DEA3: D0 E5     BNE bra_DE8A_write_power_pellet_markers
...
C - - - - - 0x001EC0 00:DEB0: F0 19     BEQ bra_DECB_finalize_ppu_command_buffer    ; skip if buffer is empty
...
C - - - - - 0x001ED0 00:DEC0: F0 E8     BEQ bra_DEAA_scan_ppu_command_buffer
C - - - - - 0x001ED2 00:DEC2: C9 FF     CMP #$FF
C - - - - - 0x001ED4 00:DEC4: F0 05     BEQ bra_DECB_finalize_ppu_command_buffer    ; skip if there isn't anything else in the buffer
C - - - - - 0x001ED6 00:DEC6: 8D 07 20  STA $2007
C - - - - - 0x001ED9 00:DEC9: D0 F1     BNE bra_DEBC_write_ppu_command_payload   ; jmp
...
C - - - - - 0x001EF6 00:DEE6: F0 36     BEQ bra_DF1E_handle_any_pellet_eaten    ; if normal pellet (rare)
C - - - - - 0x001EF8 00:DEE8: E8        INX
C - - - - - 0x001EF9 00:DEE9: E8        INX
C - - - - - 0x001EFA 00:DEEA: C9 03     CMP #con_tile + $03
C - - - - - 0x001EFC 00:DEEC: F0 30     BEQ bra_DF1E_handle_any_pellet_eaten    ; if normal pellet
C - - - - - 0x001EFE 00:DEEE: C9 01     CMP #con_tile + $01
C - - - - - 0x001F00 00:DEF0: F0 05     BEQ bra_DEF7_handle_power_pellet_eaten    ; if power pellet (visible)
C - - - - - 0x001F02 00:DEF2: C9 02     CMP #con_tile + $02
C - - - - - 0x001F04 00:DEF4: F0 01     BEQ bra_DEF7_handle_power_pellet_eaten    ; if power pellet (not visible)
C - - - - - 0x001F06 00:DEF6: 60        RTS
; Handle power-pellet eat path
bra_DEF7_handle_power_pellet_eaten:		; was: bra_DEF7
C - - - - - 0x001F07 00:DEF7: 20 C6 DF  JSR sub_DFC6_start_frightened_mode
...
C - - - - - 0x001F12 00:DF02: 20 DD E1  JSR sub_E1DD_convert_world_pos_to_ppu_addr
C - - - - - 0x001F15 00:DF05: A2 00     LDX #$00
C - - - - - 0x001F17 00:DF07: A5 03     LDA ram_0003
C - - - - - 0x001F19 00:DF09: 29 07     AND #$07
C - - - - - 0x001F1B 00:DF0B: F0 02     BEQ bra_DF0F_select_power_pellet_slot_by_row
...
C - - - - - 0x001F25 00:DF15: F0 01     BEQ bra_DF18_mark_power_pellet_slot_eaten
...
C - - - - - 0x001F3C 00:DF2C: 20 DD E1  JSR sub_E1DD_convert_world_pos_to_ppu_addr
...
C - - - - - 0x001F47 00:DF37: D0 F8     BNE bra_DF31_find_ppu_buffer_end
C - - - - - 0x001F49 00:DF39: 98        TYA
C - - - - - 0x001F4A 00:DF3A: F0 06     BEQ bra_DF42_append_pellet_clear_ppu_cmd
...
C - - - - - 0x001F5E 00:DF4E: BD A6 DF  LDA tbl_DFA6_pellet_clear_tile_and_points,X
...
C - - - - - 0x001F6F 00:DF5F: BD A7 DF  LDA tbl_DFA6_pellet_clear_tile_and_points_alias + $01,X
C - - - - - 0x001F72 00:DF62: 85 DC     STA ram_00DC
C - - - - - 0x001F74 00:DF64: C6 6A     DEC ram_pellet_cnt_p1
C - - - - - 0x001F76 00:DF66: D0 0C     BNE bra_DF74_check_fruit_spawn_thresholds
...
C - - - - - 0x001F88 00:DF78: F0 04     BEQ bra_DF7E_spawn_fruit_item
C - - - - - 0x001F8A 00:DF7A: C9 86     CMP #$86
C - - - - - 0x001F8C 00:DF7C: D0 1B     BNE bra_DF99_play_pellet_sfx_and_score
...
C - - - - - 0x001F98 00:DF88: B9 BE DF  LDA tbl_DFBE_fruit_sprite_tile_by_stage,Y
...
C - - - - - 0x001FB3 00:DFA3: 4C 60 E0  JMP loc_E060_add_points_and_update_score_buffers
...
- - - - - - 0x001FC0 00:DFB0: D0 05     BNE bra_DFB7_next_release_slot_legacy
...
- - - - - - 0x001FCB 00:DFBB: D0 F1     BNE bra_DFAE_find_free_release_slot_legacy
...
C - - - - - 0x001FD8 00:DFC8: D0 06     BNE bra_DFD0_store_frightened_timer
...
C - - - - - 0x001FF1 00:DFE1: 10 F5     BPL bra_DFD8_set_ghost_palette_frightened
...
C - - - - - 0x001FFB 00:DFEB: D0 F8     BNE bra_DFE5_find_ppu_buffer_end_for_palette_cmd
C - - - - - 0x001FFD 00:DFED: A2 00     LDX #$00
C - - - - - 0x001FFF 00:DFEF: 98        TYA
C - - - - - 0x002000 00:DFF0: D0 01     BNE bra_DFF3_adjust_palette_cmd_offset
...
C - - - - - 0x002003 00:DFF3: BD 5B E0  LDA tbl_E05B_frightened_palette_cmd_alt,X
...
C - - - - - 0x00200D 00:DFFD: D0 F4     BNE bra_DFF3_append_frightened_palette_cmd
...
C - - - - - 0x002029 00:E019: F0 04     BEQ bra_E01F_process_reversal_entry
C - - - - - 0x00202B 00:E01B: A5 D2     LDA ram_00D2
C - - - - - 0x00202D 00:E01D: D0 27     BNE bra_E046_next_ghost_for_reversal
...
C - - - - - 0x002033 00:E023: D0 21     BNE bra_E046_next_ghost_for_reversal
...
C - - - - - 0x002048 00:E038: D0 08     BNE bra_E042_store_reversed_direction
...
C - - - - - 0x002050 00:E040: D0 04     BNE bra_E046_next_ghost_for_reversal
...
C - - - - - 0x002068 00:E058: D0 C5     BNE bra_E01F_process_reversal_for_active_ghosts
...
C - - - - - 0x002072 00:E062: F0 01     BEQ bra_E065_score_update_live_only
...
C - - - - - 0x002087 00:E077: 90 06     BCC bra_E07F_clear_pending_score_digit
...
C - - - - - 0x002097 00:E087: D0 E3     BNE bra_E06C_add_pending_score_digits
...
C - - - - - 0x00209F 00:E08F: 20 48 E1  JSR sub_E148_digit_to_score_tile
C - - - - - 0x0020A2 00:E092: C9 30     CMP #$30
C - - - - - 0x0020A4 00:E094: D0 0F     BNE bra_E0A5_store_formatted_score_digit
...
C - - - - - 0x0020AD 00:E09D: D0 ED     BNE bra_E08C_skip_leading_zeroes
...
C - - - - - 0x0020B2 00:E0A2: 20 48 E1  JSR sub_E148_digit_to_score_tile
...
C - - - - - 0x0020BA 00:E0AA: 10 F3     BPL bra_E09F_write_formatted_score_digits
C - - - - - 0x0020BC 00:E0AC: A5 6B     LDA ram_006B
C - - - - - 0x0020BE 00:E0AE: D0 60     BNE bra_E110_compare_score_with_hiscore
C - - - - - 0x0020C0 00:E0B0: A9 01     LDA #$01
C - - - - - 0x0020C2 00:E0B2: C5 73     CMP ram_score_p1 + $03
C - - - - - 0x0020C4 00:E0B4: D0 5A     BNE bra_E110_compare_score_with_hiscore
...
C - - - - - 0x0020DF 00:E0CF: D0 F8     BNE bra_E0C9_find_ppu_buffer_end_for_life_icon
C - - - - - 0x0020E1 00:E0D1: 98        TYA
C - - - - - 0x0020E2 00:E0D2: F0 06     BEQ bra_E0DA_select_life_icon_nametable
...
C - - - - - 0x0020EE 00:E0DE: F0 02     BEQ bra_E0E2_init_life_icon_packet_copy
...
C - - - - - 0x0020F6 00:E0E6: BD 3A E1  LDA tbl_E13A_life_icon_ppu_packets,X
...
C - - - - - 0x002101 00:E0F1: BD 3A E1  LDA tbl_E13A_life_icon_ppu_packets,X
...
C - - - - - 0x002110 00:E100: BD 3A E1  LDA tbl_E13A_life_icon_ppu_packets,X
C - - - - - 0x002113 00:E103: 99 4B 02  STA ram_ppu_buffer_main,Y
C - - - - - 0x002116 00:E106: C6 02     DEC ram_0002
C - - - - - 0x002118 00:E108: D0 F4     BNE bra_E0FE_copy_life_icon_payload
C - - - - - 0x00211A 00:E10A: C8        INY
C - - - - - 0x00211B 00:E10B: E8        INX
C - - - - - 0x00211C 00:E10C: E0 0A     CPX #$0A
C - - - - - 0x00211E 00:E10E: D0 D6     BNE bra_E0E6_copy_life_icon_packet
...
C - - - - - 0x002128 00:E118: F0 03     BEQ bra_E11D_continue_hiscore_compare
C - - - - - 0x00212A 00:E11A: 90 05     BCC bra_E121_promote_score_to_hiscore
...
C - - - - - 0x00212E 00:E11E: 10 F2     BPL bra_E112_hiscore_compare_loop
...
C - - - - - 0x00213C 00:E12C: D0 F5     BNE bra_E123_copy_score_buf_to_hiscore_buf
...
C - - - - - 0x002147 00:E137: D0 F7     BNE bra_E130_copy_score_ram_to_hiscore_ram
...
C - - - - - 0x00215C 00:E14C: B0 03     BCS bra_E151_convert_hex_digit_tile
...
C - - - - - 0x00216C 00:E15C: 20 DD E1  JSR sub_E1DD_convert_world_pos_to_ppu_addr
...
C - - - - - 0x002185 00:E175: 20 DD E1  JSR sub_E1DD_convert_world_pos_to_ppu_addr
...
C - - - - - 0x002198 00:E188: 20 4E E2  JSR sub_E24E_sub_row_stride_0020
...
C - - - - - 0x0021C5 00:E1B5: 20 40 E2  JSR sub_E240_add_row_stride_0020
...
C - - - - - 0x0021EA 00:E1DA: D0 91     BNE bra_E16D_build_neighbor_ppu_positions
...
C - - - - - 0x002221 00:E211: D0 01     BNE bra_E214_apply_player2_nametable_offset
...
C - - - - - 0x00224D 00:E23D: D0 E4     BNE bra_E223_sample_next_obj_neighbor_tile
...
C - - - - - 0x002278 00:E268: F0 04     BEQ bra_E26E_select_maze_target_nametable
...
C - - - - - 0x00227E 00:E26E: AD F9 FF  LDA tbl_FFF8_maze_rle_stream_ptr + $01
C - - - - - 0x002281 00:E271: 85 01     STA ram_0001
C - - - - - 0x002283 00:E273: AD F8 FF  LDA tbl_FFF8_maze_rle_stream_ptr
...
C - - - - - 0x0022B4 00:E2A4: 10 F7     BPL bra_E29D_write_maze_rle_run
C - - - - - 0x0022B6 00:E2A6: C8        INY
C - - - - - 0x0022B7 00:E2A7: D0 02     BNE bra_E2AB_continue_maze_row_decode
...
C - - - - - 0x0022BD 00:E2AD: D0 DE     BNE bra_E28D_decode_next_maze_rle_token
...
C - - - - - 0x0022CD 00:E2BD: D0 BD     BNE bra_E27C_upload_next_maze_row
...
C - - - - - 0x0022DD 00:E2CD: F0 04     BEQ bra_E2D3_select_bottom_banner_nametable
...
C - - - - - 0x0022F2 00:E2E2: B9 FC E2  LDA tbl_E2FC_bottom_banner_fill_tiles,Y
...
C - - - - - 0x0022F9 00:E2E9: 10 FA     BPL bra_E2E5_write_bottom_banner_row
...
C - - - - - 0x002309 00:E2F9: 10 D8     BPL bra_E2D3_fill_bottom_banner_rows
...
C - - - - - 0x00233B 00:E32B: D0 08     BNE bra_E335_select_next_nametable_phase
...
C - - - - - 0x002347 00:E337: D0 10     BNE bra_E349_clear_attribute_blocks_phase
...
C - - - - - 0x002356 00:E346: 4C 10 E3  JMP loc_E310_clear_nametable_fill_pass
...
C - - - - - 0x002377 00:E367: D0 01     BNE bra_E36A_select_second_attr_block
...
C - - - - - 0x00239B 00:E38B: F0 18     BEQ bra_E3A5_select_score_addr_triplet
C - - - - - 0x00239D 00:E38D: A9 28     LDA #$28
C - - - - - 0x00239F 00:E38F: 85 00     STA ram_0000
C - - - - - 0x0023A1 00:E391: D0 12     BNE bra_E3A5_select_score_addr_triplet    ; jmp
...
C - - - - - 0x0023B9 00:E3A9: F0 05     BEQ bra_E3B0_init_hud_row_counter
...
C - - - - - 0x0023D1 00:E3C1: BD 19 E4  LDA tbl_E419_score_source_triplets,X
C - - - - - 0x0023D4 00:E3C4: 85 02     STA ram_0002
C - - - - - 0x0023D6 00:E3C6: BD 1A E4  LDA tbl_E419_score_source_triplets + $01,X
C - - - - - 0x0023D9 00:E3C9: 85 03     STA ram_0003
C - - - - - 0x0023DB 00:E3CB: 20 EE E3  JSR sub_E3EE_write_6digit_score_to_ppu
...
C - - - - - 0x0023F3 00:E3E3: D0 04     BNE bra_E3E9_continue_hud_row_loop
C - - - - - 0x0023F5 00:E3E5: A5 47     LDA ram_game_mode
C - - - - - 0x0023F7 00:E3E7: F0 04     BEQ bra_E3ED_return
; Continue HUD row loop unless done
bra_E3E9_continue_hud_row_loop:		; was: bra_E3E9
C - - - - - 0x0023F9 00:E3E9: A5 05     LDA ram_0005
C - - - - - 0x0023FB 00:E3EB: D0 C7     BNE bra_E3B4_draw_next_hud_row
...
C - - - - - 0x002404 00:E3F4: D0 0C     BNE bra_E402_emit_score_digit_tile
C - - - - - 0x002406 00:E3F6: A9 20     LDA #con_tile + $20
C - - - - - 0x002408 00:E3F8: 8D 07 20  STA $2007
C - - - - - 0x00240B 00:E3FB: 88        DEY
C - - - - - 0x00240C 00:E3FC: D0 F2     BNE bra_E3F0_skip_leading_zeros_in_score
C - - - - - 0x00240E 00:E3FE: F0 0B     BEQ bra_E40B_write_last_digit_and_suffix    ; jmp
...
C - - - - - 0x002412 00:E402: 20 48 E1  JSR sub_E148_digit_to_score_tile
C - - - - - 0x002415 00:E405: 8D 07 20  STA $2007
C - - - - - 0x002418 00:E408: 88        DEY
C - - - - - 0x002419 00:E409: D0 F5     BNE bra_E400_write_remaining_score_digits
...
C - - - - - 0x00241D 00:E40D: 20 48 E1  JSR sub_E148_digit_to_score_tile
...
C - - - - - 0x00244A 00:E43A: F0 08     BEQ bra_E444_store_candidate_direction
C - - - - - 0x00244C 00:E43C: 29 F8     AND #$F8
C - - - - - 0x00244E 00:E43E: F0 04     BEQ bra_E444_store_candidate_direction
C - - - - - 0x002450 00:E440: C5 0B     CMP ram_000B
C - - - - - 0x002452 00:E442: D0 04     BNE bra_E448_next_neighbor_tile
...
C - - - - - 0x00245B 00:E44B: D0 E9     BNE bra_E436_scan_neighbor_tiles
...
C - - - - - 0x002475 00:E465: D0 0B     BNE bra_E472_next_compaction_index
...
C - - - - - 0x002485 00:E475: D0 E9     BNE bra_E460_shift_candidate_entry
C - - - - - 0x002487 00:E477: C6 0B     DEC ram_000B
C - - - - - 0x002489 00:E479: D0 E3     BNE bra_E45E_compact_candidate_list
...
C - - - - - 0x002490 00:E480: B9 B6 E4  LDA tbl_E4B6_hud_block_packets,Y
C - - - - - 0x002493 00:E483: E0 00     CPX #$00
C - - - - - 0x002495 00:E485: D0 02     BNE bra_E489_write_hud_block_addr_hi
...
C - - - - - 0x00249D 00:E48D: B9 B6 E4  LDA tbl_E4B6_hud_block_packets,Y
C - - - - - 0x0024A0 00:E490: 8D 06 20  STA $2006
C - - - - - 0x0024A3 00:E493: C8        INY
C - - - - - 0x0024A4 00:E494: B9 B6 E4  LDA tbl_E4B6_hud_block_packets,Y
...
C - - - - - 0x0024AA 00:E49A: B9 B6 E4  LDA tbl_E4B6_hud_block_packets,Y
C - - - - - 0x0024AD 00:E49D: 8D 07 20  STA $2007
C - - - - - 0x0024B0 00:E4A0: C6 00     DEC ram_0000
C - - - - - 0x0024B2 00:E4A2: D0 F5     BNE bra_E499_write_hud_block_payload
C - - - - - 0x0024B4 00:E4A4: C8        INY
C - - - - - 0x0024B5 00:E4A5: C0 11     CPY #$11
C - - - - - 0x0024B7 00:E4A7: D0 05     BNE bra_E4AE_continue_hud_block_stream
C - - - - - 0x0024B9 00:E4A9: A5 47     LDA ram_game_mode
C - - - - - 0x0024BB 00:E4AB: D0 01     BNE bra_E4AE_continue_hud_block_stream
...
C - - - - - 0x0024C0 00:E4B0: D0 CE     BNE bra_E480_stream_hud_block_packet
C - - - - - 0x0024C2 00:E4B2: CA        DEX
C - - - - - 0x0024C3 00:E4B3: F0 C9     BEQ bra_E47E_next_hud_block_page
...
C - - - - - 0x0024DF 00:E4CF: D0 01     BNE bra_E4D2_prepare_lives_draw
...
C - - - - - 0x0024E7 00:E4D7: 90 02     BCC bra_E4DB_init_life_icon_write_state
...
C - - - - - 0x0024FD 00:E4ED: F0 07     BEQ bra_E4F6_next_life_icon_slot
...
C - - - - - 0x002508 00:E4F8: D0 01     BNE bra_E4FB_next_life_icon_row
...
C - - - - - 0x00250D 00:E4FD: D0 07     BNE bra_E506_write_life_icon_quad
...
C - - - - - 0x002518 00:E508: 20 14 E5  JSR sub_E514_write_icon_quad_to_ppu
...
C - - - - - 0x002522 00:E512: D0 E2     BNE bra_E4F6_next_life_icon_slot    ; jmp
...
C - - - - - 0x002568 00:E558: 90 0D     BCC bra_E567_stage_history_base_index_zero
C - - - - - 0x00256A 00:E55A: C9 0C     CMP #$0C
C - - - - - 0x00256C 00:E55C: 90 02     BCC bra_E560_clamp_stage_history_index
...
C - - - - - 0x002575 00:E565: D0 02     BNE bra_E569_init_fruit_history_ppu_base    ; jmp
...
C - - - - - 0x002585 00:E575: F0 07     BEQ bra_E57E_apply_player2_fruit_history_offset
...
C - - - - - 0x002594 00:E584: D0 07     BNE bra_E58D_select_fruit_icon_tile
...
C - - - - - 0x00259D 00:E58D: BD 19 E6  LDA tbl_E619_stage_to_fruit_icon_index,X
...
C - - - - - 0x0025A7 00:E597: 20 14 E5  JSR sub_E514_write_icon_quad_to_ppu
C - - - - - 0x0025AA 00:E59A: A4 03     LDY ram_0003
C - - - - - 0x0025AC 00:E59C: B9 2D E6  LDA tbl_E62D_history_mask_offsets,Y
C - - - - - 0x0025AF 00:E59F: 85 06     STA ram_0006
C - - - - - 0x0025B1 00:E5A1: B9 2E E6  LDA tbl_E62D_history_mask_offsets + $01,Y
C - - - - - 0x0025B4 00:E5A4: 85 07     STA ram_0007
C - - - - - 0x0025B6 00:E5A6: A4 05     LDY ram_0005
C - - - - - 0x0025B8 00:E5A8: B9 3D E6  LDA tbl_E63D_history_mask_seed_bits,Y
...
C - - - - - 0x0025BD 00:E5AD: 30 04     BMI bra_E5B3_accumulate_history_mask
C - - - - - 0x0025BF 00:E5AF: 0A        ASL
C - - - - - 0x0025C0 00:E5B0: 0A        ASL
C - - - - - 0x0025C1 00:E5B1: 90 F8     BCC bra_E5AB_build_history_mask_bits
...
C - - - - - 0x0025D9 00:E5C9: 10 B7     BPL bra_E582_draw_next_fruit_history_icon
...
C - - - - - 0x0025E1 00:E5D1: F0 02     BEQ bra_E5D5_init_history_mask_upload
...
C - - - - - 0x0025FD 00:E5ED: D0 F6     BNE bra_E5E5_upload_history_mask_bytes
C - - - - - 0x0025FF 00:E5EF: E6 02     INC ram_0002
C - - - - - 0x002601 00:E5F1: D0 0C     BNE bra_E5FF_upload_fruit_palette_color
; 23ED or 2BED
...
C - - - - - 0x00260D 00:E5FD: D0 E2     BNE bra_E5E1_next_history_mask_row   ; jmp
...
C - - - - - 0x00261D 00:E60D: 90 02     BCC bra_E611_clamp_fruit_color_index
...
C - - - - - 0x002622 00:E612: B9 45 E6  LDA tbl_E645_stage_fruit_palette_color,Y
...
C - - - - - 0x00266F 00:E65F: 10 FB     BPL bra_E65C_wait_vblank_set_flag
...
C - - - - - 0x00267E 00:E66E: 20 C4 E6  JSR sub_E6C4_clear_playfield_and_walls
...
C - - - - - 0x0026B0 00:E6A0: B9 3B E7  LDA tbl_E73B_intro_sprite_palette,Y
C - - - - - 0x0026B3 00:E6A3: 8D 07 20  STA $2007
C - - - - - 0x0026B6 00:E6A6: C8        INY
C - - - - - 0x0026B7 00:E6A7: C0 10     CPY #$10
C - - - - - 0x0026B9 00:E6A9: D0 F5     BNE bra_E6A0_upload_demo_sprite_palette
...
C - - - - - 0x0026D1 00:E6C1: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x0026DA 00:E6CA: F0 02     BEQ bra_E6CE_select_playfield_nametable
...
C - - - - - 0x002700 00:E6F0: F0 08     BEQ bra_E6FA_switch_pattern_phase
C - - - - - 0x002702 00:E6F2: C6 01     DEC ram_0001
C - - - - - 0x002704 00:E6F4: D0 F5     BNE bra_E6EB_write_playfield_pattern_byte
C - - - - - 0x002706 00:E6F6: A9 20     LDA #$20
C - - - - - 0x002708 00:E6F8: D0 F1     BNE bra_E6EB_write_playfield_pattern_byte    ; jmp
...
C - - - - - 0x00270C 00:E6FC: F0 08     BEQ bra_E706_advance_pattern_repeat_counter
C - - - - - 0x00270E 00:E6FE: C6 02     DEC ram_0002
C - - - - - 0x002710 00:E700: D0 E9     BNE bra_E6EB_write_playfield_pattern_byte
C - - - - - 0x002712 00:E702: A9 2D     LDA #$2D
C - - - - - 0x002714 00:E704: D0 E5     BNE bra_E6EB_write_playfield_pattern_byte    ; jmp
; Advance pattern repeat counter
bra_E706_advance_pattern_repeat_counter:		; was: bra_E706
C - - - - - 0x002716 00:E706: C6 03     DEC ram_0003
C - - - - - 0x002718 00:E708: D0 E1     BNE bra_E6EB_write_playfield_pattern_byte
C - - - - - 0x00271A 00:E70A: C6 00     DEC ram_0000
C - - - - - 0x00271C 00:E70C: D0 CF     BNE bra_E6DD_fill_playfield_row_pattern
...
C - - - - - 0x002727 00:E717: D0 F8     BNE bra_E711_clear_attribute_block
C - - - - - 0x002729 00:E719: A5 87     LDA ram_0087
C - - - - - 0x00272B 00:E71B: C9 02     CMP #$02
C - - - - - 0x00272D 00:E71D: F0 01     BEQ bra_E720_draw_center_marker_if_mode2
...
C - - - - - 0x002736 00:E726: F0 02     BEQ bra_E72A_select_center_marker_nametable
...
C - - J - - 0x00275B 00:E74B: 20 A5 E9  JSR sub_E9A5_update_intermission_actor_positions
C - - - - - 0x00275E 00:E74E: 20 20 EA  JSR sub_EA20_run_intermission_animation_dispatch
C - - - - - 0x002761 00:E751: 20 5C DA  JSR sub_DA5C_build_oam_from_sprite_buffers
C - - - - - 0x002764 00:E754: 20 5A E7  JSR sub_E75A_run_intermission_scene_dispatch
C - - - - - 0x002767 00:E757: 4C DD C9  JMP loc_C9DD_gameplay_mainloop_wait_nmi
...
C - - - - - 0x00276C 00:E75C: B9 69 E7  LDA tbl_E769_intermission_scene_handlers,Y
C - - - - - 0x00276F 00:E75F: 85 10     STA ram_indirect_jmp
C - - - - - 0x002771 00:E761: B9 6A E7  LDA tbl_E769_intermission_scene_handlers + $01,Y
...
- D 3 - - - 0x002779 00:E769: 6F E7     .word ofs_012_E76F_scene00_chase_opening
- D 3 - - - 0x00277B 00:E76B: 53 E8     .word ofs_012_E853_scene01_chase_rip_opening
- D 3 - - - 0x00277D 00:E76D: FA E8     .word ofs_012_E8FA_scene02_chase_return_opening
...
C - - - - - 0x002781 00:E771: B9 7E E7  LDA tbl_E77E_scene00_state_handlers,Y
C - - - - - 0x002784 00:E774: 85 10     STA ram_indirect_jmp
C - - - - - 0x002786 00:E776: B9 7F E7  LDA tbl_E77E_scene00_state_handlers + $01,Y
...
- D 3 - - - 0x00278E 00:E77E: 86 E7     .word ofs_013_E786_scene00_wait_enemy4_left_entry
- D 3 - - - 0x002790 00:E780: AF E7     .word ofs_013_E7AF_scene00_wait_pacman_wrap_left
- D 3 - - - 0x002792 00:E782: DA E7     .word ofs_013_E7DA_scene00_wait_pacman_midpoint
- D 3 - - - 0x002794 00:E784: 46 E8     .word ofs_013_E846_scene00_wait_ghost_pack_wrap
...
C - - - - - 0x00279B 00:E78B: 90 01     BCC bra_E78E_scene00_start_chase_actor
...
C - - - - - 0x0027C2 00:E7B2: F0 01     BEQ bra_E7B5_scene00_spawn_pacman_runner
...
C - - - - - 0x0027F7 00:E7E7: B0 01     BCS bra_E7EA_scene00_spawn_ghost_pack
...
C - - - - - 0x002859 00:E849: F0 01     BEQ bra_E84C_scene00_finish_to_script00
...
C - - - - - 0x002860 00:E850: 4C A0 E9  JMP loc_E9A0_set_script00_return
...
C - - - - - 0x002865 00:E855: B9 62 E8  LDA tbl_E862_scene01_state_handlers,Y
C - - - - - 0x002868 00:E858: 85 10     STA ram_indirect_jmp
C - - - - - 0x00286A 00:E85A: B9 63 E8  LDA tbl_E862_scene01_state_handlers + $01,Y
...
- D 3 - - - 0x002872 00:E862: 68 E8     .word ofs_014_E868_scene01_wait_enemy4_left_entry
- D 3 - - - 0x002874 00:E864: 91 E8     .word ofs_014_E891_scene01_handle_rip_transform
- D 3 - - - 0x002876 00:E866: CB E8     .word ofs_014_E8CB_scene01_blink_rip_tiles_then_finish
...
C - - - - - 0x00287D 00:E86D: 90 01     BCC bra_E870_scene01_start_chase_actor
...
C - - - - - 0x0028A6 00:E896: D0 23     BNE bra_E8BB_scene01_check_second_trigger
...
C - - - - - 0x0028CD 00:E8BD: F0 01     BEQ bra_E8C0_scene01_advance_to_blink_phase
...
C - - - - - 0x0028E0 00:E8D0: D0 0F     BNE bra_E8E1_scene01_wait_blink_timer
...
C - - - - - 0x0028F3 00:E8E3: F0 01     BEQ bra_E8E6_scene01_toggle_or_finish
...
C - - - - - 0x0028FB 00:E8EB: D0 03     BNE bra_E8F0_scene01_set_blink_tile_alt
C - - - - - 0x0028FD 00:E8ED: 4C A0 E9  JMP loc_E9A0_set_script00_return
...
C - - - - - 0x00290C 00:E8FC: B9 09 E9  LDA tbl_E909_scene02_state_handlers,Y
C - - - - - 0x00290F 00:E8FF: 85 10     STA ram_indirect_jmp
C - - - - - 0x002911 00:E901: B9 0A E9  LDA tbl_E909_scene02_state_handlers + $01,Y
...
- D 3 - - - 0x002919 00:E909: 11 E9     .word ofs_015_E911_scene02_wait_enemy4_left_entry
- D 3 - - - 0x00291B 00:E90B: 3A E9     .word ofs_015_E93A_scene02_wait_pacman_wrap_left
- D 3 - - - 0x00291D 00:E90D: 65 E9     .word ofs_015_E965_scene02_wait_return_midpoint
- D 3 - - - 0x00291F 00:E90F: 96 E9     .word ofs_015_E996_scene02_wait_chaser_wrap
...
C - - - - - 0x002926 00:E916: 90 01     BCC bra_E919_scene02_start_chase_actor
...
C - - - - - 0x00294D 00:E93D: F0 01     BEQ bra_E940_scene02_spawn_pacman_return_runner
...
C - - - - - 0x002982 00:E972: B0 01     BCS bra_E975_scene02_spawn_chaser_actor
...
C - - - - - 0x0029A9 00:E999: F0 01     BEQ bra_E99C_scene02_finish_to_script00
...
C - - - - - 0x0029CB 00:E9BB: F0 43     BEQ bra_EA00_advance_actor_pointer
...
C - - - - - 0x0029DE 00:E9CE: 90 0A     BCC bra_E9DA_actor_in_visible_range
...
C - - - - - 0x0029E8 00:E9D8: D0 0C     BNE bra_E9E6_continue_actor_bounds_check    ; jmp
; Actor within visible horizontal range
bra_E9DA_actor_in_visible_range:		; was: bra_E9DA
C - - - - - 0x0029EA 00:E9DA: C9 40     CMP #$40
C - - - - - 0x0029EC 00:E9DC: 90 F2     BCC bra_E9D0_loop_mark_actor_horizontal_wrap
...
C - - - - - 0x0029FC 00:E9EC: 90 0E     BCC bra_E9FC_actor_not_outside_vertical_bounds
...
C - - - - - 0x002A0A 00:E9FA: D0 04     BNE bra_EA00_advance_actor_pointer
...
C - - - - - 0x002A0E 00:E9FE: 90 EE     BCC bra_E9EE_loop_reset_offscreen_actor
...
C - - - - - 0x002A2D 00:EA1D: D0 98     BNE bra_E9B7_loop_update_next_actor
...
C - - - - - 0x002A32 00:EA22: B9 2F EA  LDA tbl_EA2F_intermission_anim_scene_handlers,Y
C - - - - - 0x002A35 00:EA25: 85 10     STA ram_indirect_jmp
C - - - - - 0x002A37 00:EA27: B9 30 EA  LDA tbl_EA2F_intermission_anim_scene_handlers + $01,Y
...
- D 3 - - - 0x002A3F 00:EA2F: 35 EA     .word ofs_016_EA35_anim_scene00_dispatch
- D 3 - - - 0x002A41 00:EA31: C9 EA     .word ofs_016_EAC9_anim_scene01_dispatch
- D 3 - - - 0x002A43 00:EA33: F9 EA     .word ofs_016_EAF9_anim_scene02_dispatch
...
C - - - - - 0x002A47 00:EA37: B9 44 EA  LDA tbl_EA44_anim_scene00_state_handlers,Y
C - - - - - 0x002A4A 00:EA3A: 85 10     STA ram_indirect_jmp
C - - - - - 0x002A4C 00:EA3C: B9 45 EA  LDA tbl_EA44_anim_scene00_state_handlers + $01,Y
...
- D 3 - - - 0x002A54 00:EA44: 4C EA     .word ofs_017_EA4C_anim_scene_base_cycle
- D 3 - - - 0x002A56 00:EA46: 62 EA     .word ofs_017_EA62_anim_scene00_head_toggle_alias
- D 3 - - - 0x002A58 00:EA48: 79 EA     .word ofs_017_EA79_anim_scene00_tail_toggle
- D 3 - - - 0x002A5A 00:EA4A: 90 EA     .word ofs_017_EA90_anim_scene00_banner_cycle
...
C - - - - - 0x002A63 00:EA53: B9 5A EA  LDA tbl_EA5A_anim_cycle_tiles,Y
...
C - - - - - 0x002A76 00:EA66: D0 E4     BNE bra_EA4C_anim_tick_palette_cycle
C - - - - - 0x002A78 00:EA68: A5 4B     LDA ram_frame_cnt
C - - - - - 0x002A7A 00:EA6A: 29 08     AND #$08
C - - - - - 0x002A7C 00:EA6C: D0 04     BNE bra_EA72_anim_scene00_select_tile_b
C - - - - - 0x002A7E 00:EA6E: A9 0C     LDA #$0C
C - - - - - 0x002A80 00:EA70: D0 02     BNE bra_EA74_anim_scene00_store_tile    ; jmp
...
C - - - - - 0x002A87 00:EA77: D0 D3     BNE bra_EA4C_anim_tick_palette_cycle    ; jmp
...
C - - - - - 0x002A8D 00:EA7D: F0 01     BEQ bra_EA80_anim_scene00_every8frames
...
C - - - - - 0x002A94 00:EA84: D0 04     BNE bra_EA8A_anim_scene00_select_tail_tile_b
C - - - - - 0x002A96 00:EA86: A9 1E     LDA #$1E
C - - - - - 0x002A98 00:EA88: D0 02     BNE bra_EA8C_anim_scene00_store_tail_tile    ; jmp
...
C - - - - - 0x002AA7 00:EA97: B9 B5 EA  LDA tbl_EAB5_anim_cycle_to_pattern_index,Y
C - - - - - 0x002AAA 00:EA9A: A8        TAY
C - - - - - 0x002AAB 00:EA9B: B9 BD EA  LDA tbl_EABD_anim_banner_tile_quads,Y
C - - - - - 0x002AAE 00:EA9E: 8D 8D 02  STA ram_028D
C - - - - - 0x002AB1 00:EAA1: B9 BE EA  LDA tbl_EABD_anim_banner_tile_quads + $01,Y
C - - - - - 0x002AB4 00:EAA4: 8D 8E 02  STA ram_028E
C - - - - - 0x002AB7 00:EAA7: B9 BF EA  LDA tbl_EABD_anim_banner_tile_quads + $02,Y
C - - - - - 0x002ABA 00:EAAA: 8D 8F 02  STA ram_028F
C - - - - - 0x002ABD 00:EAAD: B9 C0 EA  LDA tbl_EABD_anim_banner_tile_quads + $03,Y
C - - - - - 0x002AC0 00:EAB0: 8D 90 02  STA ram_0290
C - - - - - 0x002AC3 00:EAB3: D0 C4     BNE bra_EA79_anim_scene00_tail_tile_toggle    ; jmp
...
C - - - - - 0x002ADB 00:EACB: B9 D8 EA  LDA tbl_EAD8_anim_scene01_state_handlers,Y
C - - - - - 0x002ADE 00:EACE: 85 10     STA ram_indirect_jmp
C - - - - - 0x002AE0 00:EAD0: B9 D9 EA  LDA tbl_EAD8_anim_scene01_state_handlers + $01,Y
...
- D 3 - - - 0x002AE8 00:EAD8: 4C EA     .word ofs_017_EA4C_anim_scene_base_cycle
- D 3 - - - 0x002AEA 00:EADA: DE EA     .word ofs_017_EADE_anim_scene01_rip_tile_toggle
- D 3 - - - 0x002AEC 00:EADC: 4C EA     .word ofs_017_EA4C_anim_scene_base_cycle_alt
...
C - - J - - 0x002AEE 00:EADE: 20 62 EA  JSR sub_EA62_anim_scene00_toggle_head_tile
C - - - - - 0x002AF1 00:EAE1: AD 74 02  LDA ram_spr_pos_X_hi
C - - - - - 0x002AF4 00:EAE4: C9 7D     CMP #$7D
C - - - - - 0x002AF6 00:EAE6: D0 06     BNE bra_EAEE_anim_scene01_check_second_tile_trigger
...
C - - - - - 0x002B00 00:EAF0: F0 01     BEQ bra_EAF3_anim_scene01_store_second_rip_tile
...
C - - - - - 0x002B0B 00:EAFB: B9 08 EB  LDA tbl_EB08_anim_scene02_state_handlers,Y
C - - - - - 0x002B0E 00:EAFE: 85 10     STA ram_indirect_jmp
C - - - - - 0x002B10 00:EB00: B9 09 EB  LDA tbl_EB08_anim_scene02_state_handlers + $01,Y
...
- D 3 - - - 0x002B18 00:EB08: 4C EA     .word ofs_017_EA4C_anim_scene_base_cycle
- D 3 - - - 0x002B1A 00:EB0A: 10 EB     .word ofs_017_EB10_anim_scene02_toggle_main_tile
- D 3 - - - 0x002B1C 00:EB0C: 2B EB     .word ofs_017_EB2B_anim_scene02_toggle_aux_tile
- D 3 - - - 0x002B1E 00:EB0E: 2B EB     .word ofs_017_EB2B_anim_scene02_toggle_aux_tile_alt
...
C - - - - - 0x002B24 00:EB14: F0 03     BEQ bra_EB19_anim_scene02_every8frames
C - - - - - 0x002B26 00:EB16: 4C 4C EA  JMP loc_EA4C_anim_tick_palette_cycle_entry
...
C - - - - - 0x002B2D 00:EB1D: D0 04     BNE bra_EB23_anim_scene02_select_main_tile_b
C - - - - - 0x002B2F 00:EB1F: A9 48     LDA #$48
C - - - - - 0x002B31 00:EB21: D0 02     BNE bra_EB25_anim_scene02_store_main_tile    ; jmp
...
C - - - - - 0x002B38 00:EB28: 4C 4C EA  JMP loc_EA4C_anim_tick_palette_cycle_entry
...
C - - - - - 0x002B3F 00:EB2F: F0 01     BEQ bra_EB32_anim_scene02_aux_every8frames
...
C - - - - - 0x002B46 00:EB36: D0 04     BNE bra_EB3C_anim_scene02_select_aux_tile_b
C - - - - - 0x002B48 00:EB38: A9 4A     LDA #$4A
C - - - - - 0x002B4A 00:EB3A: D0 02     BNE bra_EB3E_anim_scene02_store_aux_tile    ; jmp
...
C - - - - - 0x002E30 00:EE20: A9 25     LDA #< ram_0625
C - - - - - 0x002E32 00:EE22: 85 F2     STA ram_00F2
C - - - - - 0x002E34 00:EE24: A9 06     LDA #> ram_0620
C - - - - - 0x002E36 00:EE26: 85 F3     STA ram_00F3
C - - - - - 0x002E38 00:EE28: AD 8C F0  LDA tbl_F08C_sfx_stream_table_ptr
C - - - - - 0x002E3B 00:EE2B: 85 F4     STA ram_00F4
C - - - - - 0x002E3D 00:EE2D: AD 8D F0  LDA tbl_F08C_sfx_stream_table_ptr + $01
...
C - - - - - 0x002E59 00:EE49: D0 F9     BNE bra_EE44_loop_clear_sfx_request_slots
...
C - - - - - 0x002E69 00:EE59: D0 F4     BNE bra_EE4F_loop_clear_channel_command_slots
...
C - - - - - 0x002E82 00:EE72: F0 3A     BEQ bra_EEAE_advance_channel_prepass
C - - - - - 0x002E84 00:EE74: C9 05     CMP #$05
C - - - - - 0x002E86 00:EE76: 90 0B     BCC bra_EE83_handle_low_priority_channel_request
...
C - - - - - 0x002E90 00:EE80: 4C AE EE  JMP loc_EEAE_advance_channel_prepass_entry
...
C - - - - - 0x002E99 00:EE89: D0 23     BNE bra_EEAE_advance_channel_prepass
...
C - - - - - 0x002EBC 00:EEAC: D0 F2     BNE bra_EEA0_loop_write_apu_register_quad
...
C - - - - - 0x002EC7 00:EEB7: 90 B5     BCC bra_EE6E_loop_scan_channel_command_slots
...
C - - - - - 0x002ED3 00:EEC3: D0 03     BNE bra_EEC8_channel_has_active_stream
C - - - - - 0x002ED5 00:EEC5: 4C 84 EF  JMP loc_EF84_advance_to_next_sound_channel_entry
...
C - - - - - 0x002EDC 00:EECC: D0 51     BNE bra_EF1F_decrement_channel_duration
...
C - - - - - 0x002EFE 00:EEEE: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
C - - - - - 0x002F05 00:EEF5: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
C - - - - - 0x002F12 00:EF02: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
C - - - - - 0x002F1F 00:EF0F: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
C - - - - - 0x002F2C 00:EF1C: 4C 2E EF  JMP loc_EF2E_decode_sound_stream_byte
...
C - - - - - 0x002F3C 00:EF2C: D0 56     BNE bra_EF84_advance_to_next_sound_channel
...
C D 3 - - - 0x002F3E 00:EF2E: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
C - - - - - 0x002F41 00:EF31: C9 F0     CMP #$F0
C - - - - - 0x002F43 00:EF33: B0 64     BCS bra_EF99_dispatch_f0_ff_control_opcode
C - - - - - 0x002F45 00:EF35: C9 C0     CMP #$C0
C - - - - - 0x002F47 00:EF37: B0 3E     BCS bra_EF77_C0_EF_fetch_channel_duration_byte_alias
; 00-BF
...
C - - - - - 0x002F50 00:EF40: BD 74 F0  LDA tbl_F074_note_period_base_pairs,X
C - - - - - 0x002F53 00:EF43: 85 FE     STA ram_00FE
C - - - - - 0x002F55 00:EF45: BD 75 F0  LDA tbl_F074_note_period_base_pairs + $01,X
C - - - - - 0x002F58 00:EF48: 85 FF     STA ram_00FF
C - - - - - 0x002F5A 00:EF4A: 68        PLA
C - - - - - 0x002F5B 00:EF4B: 29 0F     AND #$0F
C - - - - - 0x002F5D 00:EF4D: F0 08     BEQ bra_EF57_00_apply_note_period_to_channel
; 01-0F
...
C - - - - - 0x002F65 00:EF55: D0 F9     BNE bra_EF50_loop_shift_note_period
...
C - - - - - 0x002F80 00:EF70: 90 05     BCC bra_EF77_fetch_channel_duration_byte
...
C - - - - - 0x002F87 00:EF77: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
C - - - - - 0x002FA3 00:EF93: B0 03     BCS bra_EF98_sound_update_done
C - - - - - 0x002FA5 00:EF95: 4C BF EE  JMP loc_EEBF_sound_channel_main_loop
...
C - - - - - 0x002FAD 00:EF9D: BD AA EF  LDA tbl_EFAA_sound_control_opcode_handlers,X
C - - - - - 0x002FB0 00:EFA0: 85 FE     STA ram_00FE
C - - - - - 0x002FB2 00:EFA2: BD AB EF  LDA tbl_EFAA_sound_control_opcode_handlers + $01,X
...
- - - - - - 0x002FBC 00:EFAC: D7 EF     .word ofs_018_EFD7_ctrl01_set_channel_reg1_low6   ; never used
- D 3 - - - 0x002FBE 00:EFAE: EF EF     .word ofs_018_EFEF_ctrl02_set_channel_reg1_mid2
- D 3 - - - 0x002FC0 00:EFB0: 07 F0     .word ofs_018_F007_ctrl03_set_channel_reg1_low4
- - - - - - 0x002FC2 00:EFB2: 1F F0     .word ofs_018_F01F_ctrl04_set_channel_reg2_raw   ; never used
- D 3 - - - 0x002FC4 00:EFB4: 2F F0     .word ofs_018_F02F_ctrl05_set_channel_reg4_raw
- - - - - - 0x002FC6 00:EFB6: 3F F0     .word ofs_018_F03F_ctrl06_set_channel_reg1_raw   ; never used
- - - - - - 0x002FC8 00:EFB8: CA EF     .word ofs_018_EFCA_07_unused_alias_turn_sound_off   ; never used
- - - - - - 0x002FCA 00:EFBA: CA EF     .word ofs_018_EFCA_08_unused_alias_turn_sound_off   ; never used
- - - - - - 0x002FCC 00:EFBC: CA EF     .word ofs_018_EFCA_09_unused_alias_turn_sound_off   ; never used
- - - - - - 0x002FCE 00:EFBE: CA EF     .word ofs_018_EFCA_0A_unused_alias_turn_sound_off   ; never used
- - - - - - 0x002FD0 00:EFC0: CA EF     .word ofs_018_EFCA_0B_unused_alias_turn_sound_off   ; never used
- - - - - - 0x002FD2 00:EFC2: CA EF     .word ofs_018_EFCA_0C_unused_alias_turn_sound_off   ; never used
- - - - - - 0x002FD4 00:EFC4: CA EF     .word ofs_018_EFCA_0D_unused_alias_turn_sound_off   ; never used
- - - - - - 0x002FD6 00:EFC6: CA EF     .word ofs_018_EFCA_0E_unused_alias_turn_sound_off   ; never used
- - - - - - 0x002FD8 00:EFC8: CA EF     .word ofs_018_EFCA_0F_unused_alias_turn_sound_off   ; never used
...
C - - - - - 0x002FE4 00:EFD4: 4C 84 EF  JMP loc_EF84_advance_to_next_sound_channel_entry



; Control F1: update channel register byte1 low 6 bits
ofs_018_EFD7_ctrl01_set_channel_reg1_low6:		; was: ofs_018_EFD7_01
- - - - - - 0x002FE7 00:EFD7: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
- - - - - - 0x002FFC 00:EFEC: 4C 2E EF  JMP loc_EF2E_decode_sound_stream_byte



; Control F2: update channel register byte1 bits 4-5
ofs_018_EFEF_ctrl02_set_channel_reg1_mid2:		; was: ofs_018_EFEF_02
C - - J - - 0x002FFF 00:EFEF: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
C - - - - - 0x003014 00:F004: 4C 2E EF  JMP loc_EF2E_decode_sound_stream_byte



; Control F3: update channel register byte1 low nibble
ofs_018_F007_ctrl03_set_channel_reg1_low4:		; was: ofs_018_F007_03
C - - J - - 0x003017 00:F007: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
C - - - - - 0x00302C 00:F01C: 4C 2E EF  JMP loc_EF2E_decode_sound_stream_byte



; Control F4: write raw value into channel register byte2
ofs_018_F01F_ctrl04_set_channel_reg2_raw:		; was: ofs_018_F01F_04
- - - - - - 0x00302F 00:F01F: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
- - - - - - 0x00303C 00:F02C: 4C 2E EF  JMP loc_EF2E_decode_sound_stream_byte



; Control F5: write raw value into channel register byte4
ofs_018_F02F_ctrl05_set_channel_reg4_raw:		; was: ofs_018_F02F_05
C - - J - - 0x00303F 00:F02F: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
C - - - - - 0x00304C 00:F03C: 4C 2E EF  JMP loc_EF2E_decode_sound_stream_byte



; Control F6: write raw value into channel register byte1
ofs_018_F03F_ctrl06_set_channel_reg1_raw:		; was: ofs_018_F03F_06
- - - - - - 0x00304F 00:F03F: 20 4F F0  JSR sub_F04F_fetch_stream_byte_and_advance_ptr
...
- - - - - - 0x00305C 00:F04C: 4C 2E EF  JMP loc_EF2E_decode_sound_stream_byte
...
- D 3 - - - 0x00309C 00:F08C: 8E F0     .word tbl_F08E_sfx_stream_ptr_table
...
- D 3 - I - 0x00309E 00:F08E: 57 F3     .word off_F357_sfx_slot00_player_ready_chA
- D 3 - I - 0x0030A0 00:F090: A0 F3     .word off_F3A0_sfx_slot01_player_ready_chB
- D 3 - I - 0x0030A2 00:F092: AE F0     .word off_F0AE_sfx_slot02_extra_life
- D 3 - I - 0x0030A4 00:F094: C8 F2     .word off_F2C8_sfx_slot03_death
- D 3 - I - 0x0030A6 00:F096: CB F3     .word off_F3CB_sfx_slot04_pellet_even
- D 3 - I - 0x0030A8 00:F098: DC F3     .word off_F3DC_sfx_slot05_pellet_odd
- D 3 - I - 0x0030AA 00:F09A: C3 F0     .word off_F0C3_sfx_slot06_fruit
- D 3 - I - 0x0030AC 00:F09C: 70 F1     .word off_F170_sfx_slot07_eat_ghost
- D 3 - I - 0x0030AE 00:F09E: A9 F2     .word off_F2A9_sfx_slot08_ghost_house_state6_marker
- D 3 - I - 0x0030B0 00:F0A0: 5B F1     .word off_F15B_sfx_slot09_ghost_house_release_marker
- D 3 - I - 0x0030B2 00:F0A2: EE F0     .word off_F0EE_sfx_slot0A_release_counter_hi
- D 3 - I - 0x0030B4 00:F0A4: 19 F1     .word off_F119_sfx_slot0B_release_counter_mid
- D 3 - I - 0x0030B6 00:F0A6: 3C F1     .word off_F13C_sfx_slot0C_release_counter_lo
- D 3 - I - 0x0030B8 00:F0A8: 93 F1     .word off_F193_sfx_slot0D_intermission_flag_a
- D 3 - I - 0x0030BA 00:F0AA: 06 F2     .word off_F206_sfx_slot0E_intermission_flag_b
- D 3 - I - 0x0030BC 00:F0AC: ED F3     .word off_F3ED_sfx_slot0F_pause_toggle
...
- D 3 - I - 0x00319C 00:F18C: F5        .byte con_sfx_ctrl_f5_set_reg4_raw
...
- D 3 - I - 0x00333E 00:F32E: F2        .byte con_sfx_ctrl_f2_set_reg1_mid2   ; 
- D 3 - I - 0x00333F 00:F32F: 00        .byte $00   ; 
- D 3 - I - 0x003340 00:F330: F3        .byte con_sfx_ctrl_f3_set_reg1_low4   ; 
- D 3 - I - 0x003341 00:F331: 00        .byte $00   ; 
- D 3 - I - 0x003342 00:F332: F5        .byte con_sfx_ctrl_f5_set_reg4_raw   ; 
...
- D 3 - I - 0x0033E9 00:F3D9: F5        .byte con_sfx_ctrl_f5_set_reg4_raw   ; 
...
- D 3 - I - 0x0033F8 00:F3E8: F5        .byte con_sfx_ctrl_f5_set_reg4_raw   ; 
...
- D 3 - I - 0x003409 00:F3F9: F5        .byte con_sfx_ctrl_f5_set_reg4_raw   ; 
- D 3 - I - 0x00340A 00:F3FA: 18        .byte $18   ; 
- D 3 - I - 0x00340B 00:F3FB: 53        .byte $53   ; 
- D 3 - I - 0x00340C 00:F3FC: 03        .byte $03   ; 
- D 3 - I - 0x00340D 00:F3FD: F5        .byte con_sfx_ctrl_f5_set_reg4_raw   ; 
...
- D 3 - I - 0x003417 00:F407: F5        .byte con_sfx_ctrl_f5_set_reg4_raw   ; 
...
- D 3 - I - 0x003423 00:F413: F5        .byte con_sfx_ctrl_f5_set_reg4_raw   ; 
- D 3 - I - 0x003424 00:F414: 18        .byte $18   ; 
- D 3 - I - 0x003425 00:F415: 93        .byte $93   ; 
- D 3 - I - 0x003426 00:F416: 0A        .byte $0A   ; 
- D 3 - I - 0x003427 00:F417: F5        .byte con_sfx_ctrl_f5_set_reg4_raw   ; 
...
- D 3 - I - 0x003431 00:F421: F5        .byte con_sfx_ctrl_f5_set_reg4_raw   ; 
...
; Pointer to compressed maze RLE stream
tbl_FFF8_maze_rle_stream_ptr:		; was: tbl_FFF8
- D 3 - - - 0x004008 00:FFF8: 78 EC     .word tbl_EC78_maze_rle_stream
...
- D 3 - - - 0x00400A 00:FFFA: FA C0     .word vec_C0FA_nmi_handler
- D 3 - - - 0x00400C 00:FFFC: 33 C0     .word vec_C033_reset_entry
