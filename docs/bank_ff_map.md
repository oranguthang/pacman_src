...
| `D0EF..D2FA` | Timers, frightened, release, fruit, collisions | `sub_update_round_timers_and_frightened`, `sub_queue_next_ghost_release`, `sub_check_actor_collisions` | High-risk logic: affects ghost release order, fright windows, scoring. Add golden tests first. |
