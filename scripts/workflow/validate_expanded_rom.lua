...
if stage_ready == nil or maze == nil or stage == nil or pointer == nil or frightened_duration == nil then
...
if not reached then
    ...
    output:write(string.format(
        "maze,%04X,%04X,%02X\nstage,%04X,%02X,%02X\nOK\n",
        maze, target, memory.readbyte(target), stage,
        memory.readbyte(stage + 1), memory.readbyte(frightened_duration)))
end
output:close()
emu.exit()
